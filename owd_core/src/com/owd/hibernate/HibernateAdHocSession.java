 ...
 */
public class HibernateAdHocSession {
private final static Logger log =  LogManager.getLogger();
    ...
    public static void main(String[] args)
    {
        try
        {
            ResultSet rs = HibernateAdHocSession.getResultSet("select top 10 * from owd_client");
            while(rs.next())
            {
        ...
        if (s == null) {
            ...
            if (sessionFactory == null) {
              ...
              //  hibernateProperties.setProperty("hibernate.c3p0.validate", "true");
                ...
                hibernateProperties.setProperty("hibernate.owd.dbname", "Adhoc");
    ...
    static String testerSQL = "SELECT COUNT(*) FROM lgxadhoc.dbo.Role";
