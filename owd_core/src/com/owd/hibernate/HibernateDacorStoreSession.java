 ...
 */
public class HibernateDacorStoreSession {
    ...
    public static Session currentSession()
        ...
        if (s == null) {
            ...
            if (sessionFactory == null) {
              ...
              //  hibernateProperties.setProperty("hibernate.c3p0.timeout", "30");
...
password = TnM9hq
                ...
                */
                ...
                hibernateProperties.setProperty("hibernate.owd.dbname", "DacorStore");
            ...
            PreparedStatement ps = HibernateDacorStoreSession.getPreparedStatement("set session wait_timeout=3700;");
             try {
                ps.executeUpdate();

                HibUtils.commit(HibernateDacorStoreSession.currentSession());
            } catch (Exception ex) {
              ex.printStackTrace();
            }
            HibernateDacorStoreSession.closePreparedStatement();
        }
        return s;
    }
    static String testerSQL = "SELECT COUNT(*) FROM Modules";
