 ...
 */
public class HibernateTimeForceSession {
private final static Logger log =  LogManager.getLogger();
        ...
        if (s == null) {
            ...
            if (sessionFactory == null) {
              ...
              //  hibernateProperties.setProperty("hibernate.c3p0.validate", "true");
                ...
                hbmConfig.setProperty("hibernate.owd.dbname", "TimeForce");
   ...
   static String testerSQL = "SELECT COUNT(*) FROM qqest.dbo.pooltester";
