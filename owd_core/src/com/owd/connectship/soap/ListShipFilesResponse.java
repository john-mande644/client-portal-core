...
/**
 * Response from the list ship files operation.
 * 
 * <p>Java class for ListShipFilesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListShipFilesResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
private final static Logger log =  LogManager.getLogger();
 *       &lt;sequence>
 *         &lt;element name="result" type="{urn:connectship-com:ampcore}ListShipFilesResult"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListShipFilesResponse", propOrder = {
    "result"
})
public class ListShipFilesResponse {

    @XmlElement(required = true)
    protected ListShipFilesResult result;
     ...
     * @return
     *     possible object is
     *     {@link ListShipFilesResult }
     *     
     */
    public ListShipFilesResult getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(ListShipFilesResult value) {
        this.result = value;
    }
