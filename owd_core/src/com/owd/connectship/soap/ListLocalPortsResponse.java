...
/**
 * Response from the list local printer ports operation.
 * 
 * <p>Java class for ListLocalPortsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListLocalPortsResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
private final static Logger log =  LogManager.getLogger();
 *       &lt;sequence>
 *         &lt;element name="result" type="{urn:connectship-com:ampcore}StringListResult"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListLocalPortsResponse", propOrder = {
    "result"
})
public class ListLocalPortsResponse {

    @XmlElement(required = true)
    protected StringListResult result;
     ...
     * @return
     *     possible object is
     *     {@link StringListResult }
     *     
     */
    public StringListResult getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(StringListResult value) {
        this.result = value;
    }
