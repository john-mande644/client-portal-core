...
/**
 * Response from the list stocks operation.
 * 
 * <p>Java class for ListStocksResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListStocksResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
private final static Logger log =  LogManager.getLogger();
 *       &lt;sequence>
 *         &lt;element name="result" type="{urn:connectship-com:ampcore}ListStocksResult"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListStocksResponse", propOrder = {
    "result"
})
public class ListStocksResponse {

    @XmlElement(required = true)
    protected ListStocksResult result;
     ...
     * @return
     *     possible object is
     *     {@link ListStocksResult }
     *     
     */
    public ListStocksResult getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(ListStocksResult value) {
        this.result = value;
    }
