...
public class Party  implements java.io.Serializable {
    ...
    private com.owd.fedEx.ShipService.TaxpayerIdentification[] tins;
 ...
 * combination within the US). */
     ...
     * @return tins
     */
    public com.owd.fedEx.ShipService.TaxpayerIdentification[] getTins() {
        return tins;
    }
     ...
     * @param tins
     */
    public void setTins(com.owd.fedEx.ShipService.TaxpayerIdentification[] tins) {
        this.tins = tins;
    }

    public com.owd.fedEx.ShipService.TaxpayerIdentification getTins(int i) {
        return tins[i];
    }

    public void setTins(int i, com.owd.fedEx.ShipService.TaxpayerIdentification value) {
        this.tins[i] = value;
    }
