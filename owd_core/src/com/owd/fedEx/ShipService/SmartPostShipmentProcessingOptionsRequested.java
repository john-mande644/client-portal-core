...
public class SmartPostShipmentProcessingOptionsRequested  implements java.io.Serializable {
    private com.owd.fedEx.ShipService.SmartPostShipmentProcessingOptionType[] options;
     ...
     * @return options
     */
    public com.owd.fedEx.ShipService.SmartPostShipmentProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.owd.fedEx.ShipService.SmartPostShipmentProcessingOptionType[] options) {
        this.options = options;
    }

    public com.owd.fedEx.ShipService.SmartPostShipmentProcessingOptionType getOptions(int i) {
        return options[i];
    }

    public void setOptions(int i, com.owd.fedEx.ShipService.SmartPostShipmentProcessingOptionType value) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SmartPostShipmentProcessingOptionsRequested.class);
