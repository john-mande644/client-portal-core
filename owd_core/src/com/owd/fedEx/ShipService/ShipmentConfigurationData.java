...
public class ShipmentConfigurationData  implements java.io.Serializable {
    /** Specifies the data that is common to dangerous goods packages in
 * the shipment. This is populated when the shipment contains packages
 * with identical dangerous goods commodities. */
    private com.owd.fedEx.ShipService.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations;
     ...
     * 
     * @return dangerousGoodsPackageConfigurations Specifies the data that is common to dangerous goods packages in
 * the shipment. This is populated when the shipment contains packages
 * with identical dangerous goods commodities.
     */
    public com.owd.fedEx.ShipService.DangerousGoodsDetail[] getDangerousGoodsPackageConfigurations() {
     ...
     * 
     * @param dangerousGoodsPackageConfigurations Specifies the data that is common to dangerous goods packages in
 * the shipment. This is populated when the shipment contains packages
 * with identical dangerous goods commodities.
     */
    public void setDangerousGoodsPackageConfigurations(com.owd.fedEx.ShipService.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations) {
        this.dangerousGoodsPackageConfigurations = dangerousGoodsPackageConfigurations;
    }

    public com.owd.fedEx.ShipService.DangerousGoodsDetail getDangerousGoodsPackageConfigurations(int i) {
        return dangerousGoodsPackageConfigurations[i];
    }

    public void setDangerousGoodsPackageConfigurations(int i, com.owd.fedEx.ShipService.DangerousGoodsDetail value) {
        this.dangerousGoodsPackageConfigurations[i] = value;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ShipmentConfigurationData.class);
