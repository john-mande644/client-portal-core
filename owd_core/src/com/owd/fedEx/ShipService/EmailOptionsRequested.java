...
public class EmailOptionsRequested  implements java.io.Serializable {
    private com.owd.fedEx.ShipService.EmailOptionType[] options;
     ...
     * @return options
     */
    public com.owd.fedEx.ShipService.EmailOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.owd.fedEx.ShipService.EmailOptionType[] options) {
        this.options = options;
    }

    public com.owd.fedEx.ShipService.EmailOptionType getOptions(int i) {
        return options[i];
    }

    public void setOptions(int i, com.owd.fedEx.ShipService.EmailOptionType value) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EmailOptionsRequested.class);
