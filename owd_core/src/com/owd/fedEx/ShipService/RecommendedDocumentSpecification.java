...
public class RecommendedDocumentSpecification  implements java.io.Serializable {
    private com.owd.fedEx.ShipService.RecommendedDocumentType[] types;
     ...
     * @return types
     */
    public com.owd.fedEx.ShipService.RecommendedDocumentType[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(com.owd.fedEx.ShipService.RecommendedDocumentType[] types) {
        this.types = types;
    }

    public com.owd.fedEx.ShipService.RecommendedDocumentType getTypes(int i) {
        return types[i];
    }

    public void setTypes(int i, com.owd.fedEx.ShipService.RecommendedDocumentType value) {
        this.types[i] = value;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RecommendedDocumentSpecification.class);
