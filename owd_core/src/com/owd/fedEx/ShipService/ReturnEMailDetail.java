...
public class ReturnEMailDetail  implements java.io.Serializable {
    ...
    /** Identifies the allowed (merchant-authorized) special services which
 * may be selected when the subsequent shipment is created. Only services
 * represented in EMailLabelAllowedSpecialServiceType will be controlled
 * by this list. */
    private com.owd.fedEx.ShipService.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices;
     ...
     * 
     * @return allowedSpecialServices Identifies the allowed (merchant-authorized) special services which
 * may be selected when the subsequent shipment is created. Only services
 * represented in EMailLabelAllowedSpecialServiceType will be controlled
 * by this list.
     */
    public com.owd.fedEx.ShipService.ReturnEMailAllowedSpecialServiceType[] getAllowedSpecialServices() {
     ...
     * 
     * @param allowedSpecialServices Identifies the allowed (merchant-authorized) special services which
 * may be selected when the subsequent shipment is created. Only services
 * represented in EMailLabelAllowedSpecialServiceType will be controlled
 * by this list.
     */
    public void setAllowedSpecialServices(com.owd.fedEx.ShipService.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices) {
        this.allowedSpecialServices = allowedSpecialServices;
    }

    public com.owd.fedEx.ShipService.ReturnEMailAllowedSpecialServiceType getAllowedSpecialServices(int i) {
        return allowedSpecialServices[i];
    }

    public void setAllowedSpecialServices(int i, com.owd.fedEx.ShipService.ReturnEMailAllowedSpecialServiceType value) {
        this.allowedSpecialServices[i] = value;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReturnEMailDetail.class);
