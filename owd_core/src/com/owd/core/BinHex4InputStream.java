...
private final static Logger log =  LogManager.getLogger();
    ...
    private void switchState(int newState) {
        ...
        if ((header == null && newState != stateError) || streamState == stateError)
            ...
            throw new IllegalStateException("Cannot switch state with header == null or in errorState");
    ...
    public void useDataFork() throws IOException {
        ...
        if (streamState == stateError)
            ...
            throw new IOException("Sorry, no random access. Cannot switch back from "
    ...
    public int read() throws IOException {
        ...
        if (seenEndOfFork) {
            ...
            return -1;//  throw new EOFException("End of fork");
