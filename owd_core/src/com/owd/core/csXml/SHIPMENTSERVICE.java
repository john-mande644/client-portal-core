...
private final static Logger log =  LogManager.getLogger();
    ...
    public SHIPMENTSERVICE(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _SCS_validator_ = new XmlStringValidator("SHIPMENTSERVICE.SCS", "Element",

                "SHIPMENTSERVICE/SCS", -1, -1, true);


        _DESCRIPTION_validator_ = new XmlStringValidator("SHIPMENTSERVICE.DESCRIPTION", "Element",

                "SHIPMENTSERVICE/DESCRIPTION", -1, -1, true);
    ...
    public Vector getValidationErrors(boolean return_on_error, boolean traverse) {
        ...
        e = _DESCRIPTION_validator_.validate(_DESCRIPTION);
    ...
    public static SHIPMENTSERVICE unmarshal(InputStream in) throws Exception {
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2py:1y0r1r0");
