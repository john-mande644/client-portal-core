...
private final static Logger log =  LogManager.getLogger();
    ...
    public LABELSTATUS(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("LABELSTATUS.ERRORCODE", "Element",

                "LABELSTATUS/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("LABELSTATUS.ERRORDESCRIPTION", "Element",

                "LABELSTATUS/ERRORDESCRIPTION", -1, -1, true);
    ...
    public static LABELSTATUS unmarshal(InputStream in) throws Exception {


        LABELSTATUS obj = new LABELSTATUS();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2cm:kd6l45");
