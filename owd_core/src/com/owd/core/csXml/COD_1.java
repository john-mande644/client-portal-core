...
private final static Logger log =  LogManager.getLogger();
    ...
    /**
     * Constant for "CODADDFREIGHT" node name.
     */

    public static final String $CODADDFREIGHT = "CODADDFREIGHT";
    ...
    protected String _CODADDFREIGHT = null;
    ...
    /**
     * Get the CODADDFREIGHT property.
     */

    public String getCODADDFREIGHT() {

        return (_CODADDFREIGHT);

    }


    /**
     * Set the CODADDFREIGHT property.
     */

    public void setCODADDFREIGHT(String newValue) {

        _CODADDFREIGHT = newValue;

    }


    /**
     * Checks for whether CODADDFREIGHT is set or not.
     *
     * @returns true if CODADDFREIGHT is set, false if not
     */

    public boolean hasCODADDFREIGHT() {

        return (_CODADDFREIGHT != null);

    }


    /**
     * Discards CODADDFREIGHT's value.
     */

    public void deleteCODADDFREIGHT() {
    ...
    protected static synchronized void createValidators() {
        ...
        _CODAMOUNT_validator_ = new XmlValidator("COD_1.CODAMOUNT", "Element",

                "COD/CODAMOUNT", true);


        _CODPAYMENTMETHOD_validator_ = new XmlStringValidator("COD_1.CODPAYMENTMETHOD", "Element",
    ...
    public static COD_1 unmarshal(InputStream in) throws Exception {
    ...
    public void fromXml(XmlElement xml) {
        ...
        if (xml.equals($CODADDFREIGHT)) {

            setCODADDFREIGHT(xml.getData());
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q31n:jvnn6x");
