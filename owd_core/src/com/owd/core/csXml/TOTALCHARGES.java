...
private final static Logger log =  LogManager.getLogger();
    ...
    public TOTALCHARGES(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _CURRENCYCODE_validator_ = new XmlStringValidator("TOTALCHARGES.CURRENCYCODE", "Element",

                "TOTALCHARGES/CURRENCYCODE", -1, -1, true);


        _MONETARYVALUE_validator_ = new XmlStringValidator("TOTALCHARGES.MONETARYVALUE", "Element",

                "TOTALCHARGES/MONETARYVALUE", -1, -1, true);
    ...
    public static boolean matches(XmlElement xml) {
        ...
        return (xml.equals($TOTALCHARGES));
    ...
    public static TOTALCHARGES unmarshal(InputStream in) throws Exception {


        TOTALCHARGES obj = new TOTALCHARGES();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2qs:jl78k7");
