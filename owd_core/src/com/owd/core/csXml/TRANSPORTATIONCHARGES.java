 ...
 *     Class Name: TRANSPORTATIONCHARGES
...
private final static Logger log =  LogManager.getLogger();
    ...
    public TRANSPORTATIONCHARGES(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _CURRENCYCODE_validator_ = new XmlStringValidator("TRANSPORTATIONCHARGES.CURRENCYCODE", "Element",

                "TRANSPORTATIONCHARGES/CURRENCYCODE", -1, -1, true);


        _MONETARYVALUE_validator_ = new XmlStringValidator("TRANSPORTATIONCHARGES.MONETARYVALUE", "Element",

                "TRANSPORTATIONCHARGES/MONETARYVALUE", -1, -1, true);
    ...
    public static boolean matches(XmlElement xml) {
        ...
        return (xml.equals($TRANSPORTATIONCHARGES));
    ...
    public static TRANSPORTATIONCHARGES unmarshal(InputStream in) throws Exception {


        TRANSPORTATIONCHARGES obj = new TRANSPORTATIONCHARGES();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2r2:u4qmpe");
