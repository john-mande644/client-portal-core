...
private final static Logger log =  LogManager.getLogger();
    ...
    protected static synchronized void createValidators() {
        ...
        _MSN_validator_ = new XmlStringValidator("MSNLIST.MSN", "Element",

                "MSNLIST/MSN", -1, -1, true);
    ...
    public static MSNLIST unmarshal(InputStream in) throws Exception {


        MSNLIST obj = new MSNLIST();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q38v:11utd59");
