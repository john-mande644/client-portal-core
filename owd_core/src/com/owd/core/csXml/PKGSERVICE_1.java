...
private final static Logger log =  LogManager.getLogger();
    ...
    public PKGSERVICE_1(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _SCS_validator_ = new XmlStringValidator("PKGSERVICE_1.SCS", "Element",

                "PKGSERVICE/SCS", -1, -1, true);


        _DESCRIPTION_validator_ = new XmlStringValidator("PKGSERVICE_1.DESCRIPTION", "Element",

                "PKGSERVICE/DESCRIPTION", -1, -1, true);
    ...
    public static PKGSERVICE_1 unmarshal(InputStream in) throws Exception {


        PKGSERVICE_1 obj = new PKGSERVICE_1();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2s7:rvwfyl");
