...
private final static Logger log =  LogManager.getLogger();
    ...
    /**
     * Constant for "CONSVALIDATED" node name.
     */

    public static final String $CONSVALIDATED = "CONSVALIDATED";
    ...
    protected String _CONSVALIDATED = null;
    ...
    public CONSIGNEE_1(XmlElement xml) {
    ...
    /**
     * Get the CONSVALIDATED property.
     */

    public String getCONSVALIDATED() {

        return (_CONSVALIDATED);

    }


    /**
     * Set the CONSVALIDATED property.
     */

    public void setCONSVALIDATED(String newValue) {

        _CONSVALIDATED = newValue;

    }


    /**
     * Checks for whether CONSVALIDATED is set or not.
     *
     * @returns true if CONSVALIDATED is set, false if not
     */

    public boolean hasCONSVALIDATED() {

        return (_CONSVALIDATED != null);

    }


    /**
     * Discards CONSVALIDATED's value.
     */

    public void deleteCONSVALIDATED() {
    ...
    protected static synchronized void createValidators() {
        ...
        _COMPANY_validator_ = new XmlStringValidator("CONSIGNEE_1.COMPANY", "Element",

                "CONSIGNEE/COMPANY", -1, -1, true);


        _ADDRESS1_validator_ = new XmlStringValidator("CONSIGNEE_1.ADDRESS1", "Element",

                "CONSIGNEE/ADDRESS1", -1, -1, true);


        _CITY_validator_ = new XmlStringValidator("CONSIGNEE_1.CITY", "Element",

                "CONSIGNEE/CITY", -1, -1, true);


        _STATEPROVINCE_validator_ = new XmlStringValidator("CONSIGNEE_1.STATEPROVINCE", "Element",

                "CONSIGNEE/STATEPROVINCE", -1, -1, true);


        _POSTALCODE_validator_ = new XmlStringValidator("CONSIGNEE_1.POSTALCODE", "Element",

                "CONSIGNEE/POSTALCODE", -1, -1, true);


        _COUNTRYSYMBOL_validator_ = new XmlStringValidator("CONSIGNEE_1.COUNTRYSYMBOL", "Element",
    ...
    public static CONSIGNEE_1 unmarshal(InputStream in) throws Exception {


        CONSIGNEE_1 obj = new CONSIGNEE_1();
    ...
    public void fromXml(XmlElement xml) {
        ...
        if (xml.equals($CONSVALIDATED)) {

            setCONSVALIDATED(xml.getData());
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2yv:nbadvl");
