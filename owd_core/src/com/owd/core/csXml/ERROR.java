...
private final static Logger log =  LogManager.getLogger();
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("ERROR.ERRORCODE", "Element",

                "ERROR/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("ERROR.ERRORDESCRIPTION", "Element",
    ...
    public static ERROR unmarshal(InputStream in) throws Exception {
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2py:1gab0zu");
