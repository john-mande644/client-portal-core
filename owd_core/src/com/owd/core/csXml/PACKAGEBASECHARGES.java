...
/**
 * PACKAGEBASECHARGES class.
 */

public class PACKAGEBASECHARGES
...
private final static Logger log =  LogManager.getLogger();
    ...
    public PACKAGEBASECHARGES(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _CURRENCYCODE_validator_ = new XmlStringValidator("PACKAGEBASECHARGES.CURRENCYCODE", "Element",

                "PACKAGEBASECHARGES/CURRENCYCODE", -1, -1, true);


        _MONETARYVALUE_validator_ = new XmlStringValidator("PACKAGEBASECHARGES.MONETARYVALUE", "Element",

                "PACKAGEBASECHARGES/MONETARYVALUE", -1, -1, true);
    ...
    public static boolean matches(XmlElement xml) {
        ...
        return (xml.equals($PACKAGEBASECHARGES));
    ...
    public static PACKAGEBASECHARGES unmarshal(InputStream in) throws Exception {


        PACKAGEBASECHARGES obj = new PACKAGEBASECHARGES();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2sr:1t1cp4p");
