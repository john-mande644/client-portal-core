...
private final static Logger log =  LogManager.getLogger();
    ...
    public PKGERROR(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("PKGERROR.ERRORCODE", "Element",

                "PKGERROR/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("PKGERROR.ERRORDESCRIPTION", "Element",
    ...
    public static PKGERROR unmarshal(InputStream in) throws Exception {


        PKGERROR obj = new PKGERROR();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2s7:7r4zoi");
