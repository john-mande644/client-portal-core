...
private final static Logger log =  LogManager.getLogger();
    ...
    public DOCUMENTS_1(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _DOCFORMAT_validator_ = new XmlStringValidator("DOCUMENTS_1.DOCFORMAT", "Element",

                "DOCUMENTS/DOCFORMAT", -1, -1, true);


        _DOCPRINT_validator_ = new XmlValidator("DOCUMENTS_1.DOCPRINT", "Element",

                "DOCUMENTS/DOCPRINT", false);
    ...
    public static DOCUMENTS_1 unmarshal(InputStream in) throws Exception {


        DOCUMENTS_1 obj = new DOCUMENTS_1();
    ...
    public String birthCertificate() {
        ...
        return ("1hge1fs:d2li2dze:74goyi");
