...
private final static Logger log =  LogManager.getLogger();
    ...
    /**
     * Constant for "LOGINID" node name.
     */
    ...
    /**
     * Checks for whether LOGINID is set or not.
     *
     * @returns true if LOGINID is set, false if not
     */

    public boolean hasLOGINID() {

        return (_LOGINID != null);

    }


    /**
     * Discards LOGINID's value.
     */
     ...
     *
     * @returns true if PASSWORD is set, false if not
     */
    ...
    protected static synchronized void createValidators() {
        ...
        _LOGINID_validator_ = new XmlStringValidator("LOGIN.LOGINID", "Element",

                "LOGIN/LOGINID", -1, -1, true);


        _PASSWORD_validator_ = new XmlStringValidator("LOGIN.PASSWORD", "Element",

                "LOGIN/PASSWORD", -1, -1, true);
    ...
    public Vector getValidationErrors(boolean return_on_error, boolean traverse) {
        ...
        e = _LOGINID_validator_.validate(_LOGINID);
        ...
        e = _PASSWORD_validator_.validate(_PASSWORD);
    ...
    public static LOGIN unmarshal(InputStream in) throws Exception {
    ...
    public void fromXml(XmlElement xml) {
        ...
        if (xml.equals($LOGINID)) {

            setLOGINID(xml.getData());
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q23z:1pf7i9k");
