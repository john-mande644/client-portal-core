...
private final static Logger log =  LogManager.getLogger();
    ...
    public SHIPPERINFO(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _SHIPPER_validator_ = new XmlStringValidator("SHIPPERINFO.SHIPPER", "Element",
    ...
    public static SHIPPERINFO unmarshal(InputStream in) throws Exception {


        SHIPPERINFO obj = new SHIPPERINFO();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q27v:2afohz");
