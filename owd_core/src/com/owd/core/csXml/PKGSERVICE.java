...
private final static Logger log =  LogManager.getLogger();
    ...
    public PKGSERVICE(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _SCS_validator_ = new XmlStringValidator("PKGSERVICE.SCS", "Element",

                "PKGSERVICE/SCS", -1, -1, true);
    ...
    public static PKGSERVICE unmarshal(InputStream in) throws Exception {


        PKGSERVICE obj = new PKGSERVICE();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2ok:fa6g61");
