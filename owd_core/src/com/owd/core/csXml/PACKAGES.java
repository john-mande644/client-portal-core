...
private final static Logger log =  LogManager.getLogger();
    ...
    public PACKAGES(XmlElement xml) {
    ...
    public PKG_1 getPKGAt(int index)

            throws IndexOutOfBoundsException {

        return ((PKG_1) _PKG.elementAt(index));
    ...
    public void setPKGAt(PKG_1 obj, int index)
    ...
    public void removePKG(PKG_1 obj) {
    ...
    protected void setPKG(XmlElement xml) {
        ...
        while (xml != null &&
                ...
                xml.equals(PKG_1.$PKG)) {

            Object obj = new PKG_1(xml);
    ...
    protected static synchronized void createValidators() {
        ...
        _PKG_validator_ = new XmlValidator("PACKAGES.PKG", "Element",
    ...
    public static PACKAGES unmarshal(InputStream in) throws Exception {
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2i6:1trzqqk");
