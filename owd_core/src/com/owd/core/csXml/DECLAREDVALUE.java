...
private final static Logger log =  LogManager.getLogger();
    ...
    public DECLAREDVALUE(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _MONETARYVALUE_validator_ = new XmlStringValidator("DECLAREDVALUE.MONETARYVALUE", "Element",

                "DECLAREDVALUE/MONETARYVALUE", -1, -1, true);
    ...
    public static boolean matches(XmlElement xml) {
        ...
        return (xml.equals($DECLAREDVALUE));
    ...
    public static DECLAREDVALUE unmarshal(InputStream in) throws Exception {


        DECLAREDVALUE obj = new DECLAREDVALUE();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2gi:5sf7ll");
