...
private final static Logger log =  LogManager.getLogger();
    ...
    public DOCSTATUS(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("DOCSTATUS.ERRORCODE", "Element",

                "DOCSTATUS/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("DOCSTATUS.ERRORDESCRIPTION", "Element",

                "DOCSTATUS/ERRORDESCRIPTION", -1, -1, true);
    ...
    public static DOCSTATUS unmarshal(InputStream in) throws Exception {


        DOCSTATUS obj = new DOCSTATUS();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q38l:6z3d71");
