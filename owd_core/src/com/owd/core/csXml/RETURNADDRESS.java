...
private final static Logger log =  LogManager.getLogger();
    ...
    public RETURNADDRESS(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _RTCOMPANY_validator_ = new XmlStringValidator("RETURNADDRESS.RTCOMPANY", "Element",

                "RETURNADDRESS/RTCOMPANY", -1, -1, true);


        _RTADDRESS1_validator_ = new XmlStringValidator("RETURNADDRESS.RTADDRESS1", "Element",

                "RETURNADDRESS/RTADDRESS1", -1, -1, true);


        _RTCITY_validator_ = new XmlStringValidator("RETURNADDRESS.RTCITY", "Element",

                "RETURNADDRESS/RTCITY", -1, -1, true);


        _RTSTATEPROVINCE_validator_ = new XmlStringValidator("RETURNADDRESS.RTSTATEPROVINCE", "Element",

                "RETURNADDRESS/RTSTATEPROVINCE", -1, -1, true);


        _RTPOSTALCODE_validator_ = new XmlStringValidator("RETURNADDRESS.RTPOSTALCODE", "Element",

                "RETURNADDRESS/RTPOSTALCODE", -1, -1, true);


        _RTCOUNTRYSYMBOL_validator_ = new XmlStringValidator("RETURNADDRESS.RTCOUNTRYSYMBOL", "Element",
    ...
    public static RETURNADDRESS unmarshal(InputStream in) throws Exception {
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q29k:19gbr42");
