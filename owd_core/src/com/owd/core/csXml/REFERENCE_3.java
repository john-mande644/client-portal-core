...
private final static Logger log =  LogManager.getLogger();
    ...
    /**
     * Constant for "NOFN_TOTAL" node name.
     */

    public static final String $NOFN_TOTAL = "NOFN_TOTAL";
    ...
    /**
     * Constant for "NOFN_SEQUENCE" node name.
     */

    public static final String $NOFN_SEQUENCE = "NOFN_SEQUENCE";
    ...
    protected String _NOFNSEQUENCE = null;

    protected String _NOFNTOTAL = null;
    ...
    public REFERENCE_3(XmlElement xml) {
    ...
    /**
     * Get the NOFNSEQUENCE property.
     */

    public String getNOFNSEQUENCE() {

        return (_NOFNSEQUENCE);

    }


    /**
     * Set the NOFNSEQUENCE property.
     */

    public void setNOFNSEQUENCE(String newValue) {

        _NOFNSEQUENCE = newValue;

    }


    /**
     * Checks for whether NOFNSEQUENCE is set or not.
     *
     * @returns true if NOFNSEQUENCE is set, false if not
     */

    public boolean hasNOFNSEQUENCE() {

        return (_NOFNSEQUENCE != null);

    }


    /**
     * Discards NOFNSEQUENCE's value.
     */

    public void deleteNOFNSEQUENCE() {
    ...
    /**
     * Get the NOFNTOTAL property.
     */

    public String getNOFNTOTAL() {
    ...
    /**
     * Set the NOFNTOTAL property.
     */

    public void setNOFNTOTAL(String newValue) {
    ...
    /**
     * Checks for whether NOFNTOTAL is set or not.
     *
     * @returns true if NOFNTOTAL is set, false if not
     */

    public boolean hasNOFNTOTAL() {

        return (_NOFNTOTAL != null);

    }


    /**
     * Discards NOFNTOTAL's value.
     */

    public void deleteNOFNTOTAL() {
    ...
    protected static synchronized void createValidators() {
        ...
        _SHIPPERREFERENCE_validator_ = new XmlStringValidator("REFERENCE_3.SHIPPERREFERENCE", "Element",
    ...
    public static REFERENCE_3 unmarshal(InputStream in) throws Exception {


        REFERENCE_3 obj = new REFERENCE_3();
    ...
    public void fromXml(XmlElement xml) {
        ...
        if (xml.equals($NOFN_SEQUENCE)) {

            setNOFNSEQUENCE(xml.getData());
        ...
        if (xml.equals($NOFN_TOTAL)) {

            setNOFNTOTAL(xml.getData());
    ...
    public void toXml(OutputStream stream, boolean embed_files) {
        ...
        out.write($NOFN_SEQUENCE,

                _NOFNSEQUENCE);

        out.write($NOFN_TOTAL,
