...
private final static Logger log =  LogManager.getLogger();
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("ERROR_1.ERRORCODE", "Element",

                "ERROR/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("ERROR_1.ERRORDESCRIPTION", "Element",

                "ERROR/ERRORDESCRIPTION", -1, -1, true);


        _EMAILSTATUS_validator_ = new XmlValidator("ERROR_1.EMAILSTATUS", "Element",
    ...
    public static ERROR_1 unmarshal(InputStream in) throws Exception {


        ERROR_1 obj = new ERROR_1();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q359:1dkyzim");
