...
private final static Logger log =  LogManager.getLogger();
    ...
    protected java.util.Vector _ITM = new java.util.Vector();
    ...
    /**
     * Get the ITM property.
     */

    public java.util.Vector getITM() {
    ...
    public ITM getITMAt(int index)

            throws IndexOutOfBoundsException {

        return ((ITM) _ITM.elementAt(index));

    }


    /**
     * Get the count of elements in the ITM property.
     */
    ...
    /**
     * Set the ITM property.
     */

    public void setITM(java.util.Vector newList) {


        if (newList == null) {

            _ITM.removeAllElements();

        } else {

            _ITM = (java.util.Vector) newList.clone();
    ...
    public void setITMAt(ITM obj, int index)
        ...
        _ITM.setElementAt(obj, index);

    }


    public void removeITM(ITM obj) {
        ...
        _ITM.removeElement(obj);

    }


    public void removeITMAt(int index)

            throws IndexOutOfBoundsException {

        _ITM.removeElementAt(index);

    }


    protected void setITM(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _ITM_validator_ = new XmlValidator("ITEMS.ITM", "Element",
    ...
    public Vector getValidationErrors(boolean return_on_error, boolean traverse) {
        ...
        is_valid = _ITM_validator_.isValid(_ITM,
    ...
    public static ITEMS unmarshal(InputStream in) throws Exception {
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2nq:p37kp4");
