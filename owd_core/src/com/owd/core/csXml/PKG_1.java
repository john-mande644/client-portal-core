...
private final static Logger log =  LogManager.getLogger();
    ...
    protected REFERENCE_2 _REFERENCE = null;
    ...
    public REFERENCE_2 getREFERENCE() {
    ...
    public void setREFERENCE(REFERENCE_2 obj) {
    ...
    protected static synchronized void createValidators() {
        ...
        _PKGWEIGHT_validator_ = new XmlValidator("PKG_1.PKGWEIGHT", "Element",

                "PKG/PKGWEIGHT", true);


        _DIMENSION_validator_ = new XmlValidator("PKG_1.DIMENSION", "Element",

                "PKG/DIMENSION", false);


        _REFERENCE_validator_ = new XmlValidator("PKG_1.REFERENCE", "Element",

                "PKG/REFERENCE", false);


        _PACKAGESERVICEOPTIONS_validator_ = new XmlValidator("PKG_1.PACKAGESERVICEOPTIONS", "Element",

                "PKG/PACKAGESERVICEOPTIONS", false);


        _CONSIGNEE_validator_ = new XmlValidator("PKG_1.CONSIGNEE", "Element",

                "PKG/CONSIGNEE", false);


        _SHIPPERINFO_validator_ = new XmlValidator("PKG_1.SHIPPERINFO", "Element",

                "PKG/SHIPPERINFO", false);


        _ITEMS_validator_ = new XmlValidator("PKG_1.ITEMS", "Element",

                "PKG/ITEMS", false);


        _PACKPRINT_validator_ = new XmlValidator("PKG_1.PACKPRINT", "Element",

                "PKG/PACKPRINT", false);


        _LABELPRINT_validator_ = new XmlValidator("PKG_1.LABELPRINT", "Element",
    ...
    public static PKG_1 unmarshal(InputStream in) throws Exception {
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2iq:1u0ny3m");
