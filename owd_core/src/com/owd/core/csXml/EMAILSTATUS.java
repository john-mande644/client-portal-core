...
private final static Logger log =  LogManager.getLogger();
    ...
    public EMAILSTATUS(XmlElement xml) {
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("EMAILSTATUS.ERRORCODE", "Element",

                "EMAILSTATUS/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("EMAILSTATUS.ERRORDESCRIPTION", "Element",

                "EMAILSTATUS/ERRORDESCRIPTION", -1, -1, true);
    ...
    public static EMAILSTATUS unmarshal(InputStream in) throws Exception {


        EMAILSTATUS obj = new EMAILSTATUS();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q2dg:74991e");
