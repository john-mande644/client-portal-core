...
private final static Logger log =  LogManager.getLogger();
    ...
    /**
     * Constant for "LABELSTATUS" node name.
     */
    ...
    protected LABELSTATUS _LABELSTATUS = null;
    ...
    public PKGERROR_1(XmlElement xml) {
    ...
    /**
     * Set the LABELSTATUS property.
     */

    public void setLABELSTATUS(LABELSTATUS obj) {
    ...
    protected void setLABELSTATUS(XmlElement xml) {
    ...
    /**
     * Checks for whether LABELSTATUS is set or not.
     *
     * @returns true if LABELSTATUS is set, false if not
     */

    public boolean hasLABELSTATUS() {

        return (_LABELSTATUS != null);

    }


    /**
     * Discards LABELSTATUS's value.
     */

    public void deleteLABELSTATUS() {
    ...
    protected static synchronized void createValidators() {
        ...
        _ERRORCODE_validator_ = new XmlStringValidator("PKGERROR_1.ERRORCODE", "Element",

                "PKGERROR/ERRORCODE", -1, -1, true);


        _ERRORDESCRIPTION_validator_ = new XmlStringValidator("PKGERROR_1.ERRORDESCRIPTION", "Element",

                "PKGERROR/ERRORDESCRIPTION", -1, -1, true);


        _LABELSTATUS_validator_ = new XmlValidator("PKGERROR_1.LABELSTATUS", "Element",

                "PKGERROR/LABELSTATUS", true);


        _HTMLSTATUS_validator_ = new XmlValidator("PKGERROR_1.HTMLSTATUS", "Element",

                "PKGERROR/HTMLSTATUS", true);


        _EMAILSTATUS_validator_ = new XmlValidator("PKGERROR_1.EMAILSTATUS", "Element",

                "PKGERROR/EMAILSTATUS", true);
    ...
    public Vector getValidationErrors(boolean return_on_error, boolean traverse) {
        ...
        is_valid = _LABELSTATUS_validator_.isValid(_LABELSTATUS,
    ...
    public static PKGERROR_1 unmarshal(InputStream in) throws Exception {


        PKGERROR_1 obj = new PKGERROR_1();
    ...
    public void toXml(OutputStream stream, boolean embed_files) {
        ...
        Object LABELSTATUS_value = getLABELSTATUS();

        if (LABELSTATUS_value instanceof XmlObject) {

            out.write(null,

                    (XmlObject) LABELSTATUS_value,
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q36n:bnu3rh");
