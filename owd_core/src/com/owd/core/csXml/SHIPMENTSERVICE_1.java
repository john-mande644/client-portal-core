...
/**
 * SHIPMENTSERVICE_1 class.
 */

public class SHIPMENTSERVICE_1
...
private final static Logger log =  LogManager.getLogger();
    ...
    protected java.util.Vector _SCS = new java.util.Vector();
    ...
    public SHIPMENTSERVICE_1(XmlElement xml) {
    ...
    public java.util.Vector getSCS() {
    ...
    public String getSCSAt(int index)

            throws IndexOutOfBoundsException {

        XmlString obj =

                (XmlString) _SCS.elementAt(index);
    ...
    /**
     * Get the count of elements in the SCS property.
     */
    ...
    public void setSCS(java.util.Vector newList) {

        if (newList == null) {

            _SCS.removeAllElements();

        } else {

            _SCS = (java.util.Vector) newList.clone();
    ...
    protected void setSCS(XmlElement xml) {
    ...
    public void addSCS(String value) {

        _SCS.addElement(new XmlString($SCS, value));

    }


    public void setSCSAt(String value, int index)
        ...
        XmlString obj =
                ...
                new XmlString($SCS, value);

        _SCS.setElementAt(obj, index);

    }


    public void removeSCSAt(int index)

            throws IndexOutOfBoundsException {


        _SCS.removeElementAt(index);
    ...
    protected static synchronized void createValidators() {
        ...
        _SCS_validator_ = new XmlStringValidator("SHIPMENTSERVICE_1.SCS", "Element",

                "SHIPMENTSERVICE/SCS", -1, -1, true);
    ...
    public static boolean matches(XmlElement xml) {
        ...
        return (xml.equals($SHIPMENTSERVICE));
    ...
    public static SHIPMENTSERVICE_1 unmarshal(InputStream in) throws Exception {


        SHIPMENTSERVICE_1 obj = new SHIPMENTSERVICE_1();
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q31x:12vizb6");
