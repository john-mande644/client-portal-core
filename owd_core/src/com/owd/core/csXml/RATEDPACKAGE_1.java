...
/**
 * RATEDPACKAGE_1 class.
 */

public class RATEDPACKAGE_1
...
private final static Logger log =  LogManager.getLogger();
    ...
    protected PKGERROR_1 _PKGERROR = null;
    ...
    protected LABELREQUESTINFO _LABELREQUESTINFO = null;
    ...
    public RATEDPACKAGE_1(XmlElement xml) {
    ...
    public void setPKGERROR(PKGERROR_1 obj) {
    ...
    /**
     * Get the LABELREQUESTINFO property.
     */

    public LABELREQUESTINFO getLABELREQUESTINFO() {

        return (_LABELREQUESTINFO);

    }


    /**
     * Set the LABELREQUESTINFO property.
     */

    public void setLABELREQUESTINFO(LABELREQUESTINFO obj) {

        _LABELREQUESTINFO = obj;

    }


    protected void setLABELREQUESTINFO(XmlElement xml) {


        _LABELREQUESTINFO =

                new LABELREQUESTINFO(xml);

    }


    /**
     * Checks for whether LABELREQUESTINFO is set or not.
     *
     * @returns true if LABELREQUESTINFO is set, false if not
     */

    public boolean hasLABELREQUESTINFO() {

        return (_LABELREQUESTINFO != null);

    }


    /**
     * Discards LABELREQUESTINFO's value.
     */

    public void deleteLABELREQUESTINFO() {

        _LABELREQUESTINFO = null;
    ...
    transient protected static XmlValidator
            ...
            _LABELREQUESTINFO_validator_ = null;
    ...
    protected static synchronized void createValidators() {
        ...
        _PKGERROR_validator_ = new XmlValidator("RATEDPACKAGE_1.PKGERROR", "Element",

                "RATEDPACKAGE/PKGERROR", true);


        _PACKAGETOTALCHARGES_validator_ = new XmlValidator("RATEDPACKAGE_1.PACKAGETOTALCHARGES", "Element",

                "RATEDPACKAGE/PACKAGETOTALCHARGES", true);


        _PACKAGEBASECHARGES_validator_ = new XmlValidator("RATEDPACKAGE_1.PACKAGEBASECHARGES", "Element",

                "RATEDPACKAGE/PACKAGEBASECHARGES", true);


        _PACKAGESERVICEOPTIONSCHARGES_validator_ = new XmlValidator("RATEDPACKAGE_1.PACKAGESERVICEOPTIONSCHARGES", "Element",

                "RATEDPACKAGE/PACKAGESERVICEOPTIONSCHARGES", true);


        _REFERENCE_validator_ = new XmlValidator("RATEDPACKAGE_1.REFERENCE", "Element",

                "RATEDPACKAGE/REFERENCE", true);


        _PKGWEIGHT_validator_ = new XmlValidator("RATEDPACKAGE_1.PKGWEIGHT", "Element",

                "RATEDPACKAGE/PKGWEIGHT", true);


        _BILLINGWEIGHT_validator_ = new XmlValidator("RATEDPACKAGE_1.BILLINGWEIGHT", "Element",

                "RATEDPACKAGE/BILLINGWEIGHT", true);


        _LABELREQUESTINFO_validator_ = new XmlValidator("RATEDPACKAGE_1.LABELREQUESTINFO", "Element",

                "RATEDPACKAGE/LABELREQUESTINFO", true);


        _PACKINGLIST_validator_ = new XmlValidator("RATEDPACKAGE_1.PACKINGLIST", "Element",
    ...
    public Vector getValidationErrors(boolean return_on_error, boolean traverse) {
        ...
        is_valid = _LABELREQUESTINFO_validator_.isValid(_LABELREQUESTINFO,
    ...
    public static RATEDPACKAGE_1 unmarshal(InputStream in) throws Exception {


        RATEDPACKAGE_1 obj = new RATEDPACKAGE_1();
    ...
    public void toXml(OutputStream stream, boolean embed_files) {
        ...
        Object LABELREQUESTINFO_value = getLABELREQUESTINFO();

        if (LABELREQUESTINFO_value instanceof XmlObject) {

            out.write(null,

                    (XmlObject) LABELREQUESTINFO_value,
    ...
    public String birthCertificate() {
        ...
        return ("1hge137:cy11q363:1mgikyj");
