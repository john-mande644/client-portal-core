...
private final static Logger log =  LogManager.getLogger();
    ...
    static {
        ...
        if (validChars.length() != 64)
            ...
            throw new IllegalStateException("Incorrect class, the static validChars entry should "
     ...
     *
     * @return the byte that was read, or -1 if end-of-file was encountered for
     *         <p/>
     *         the first time. Any subsequent read throws an EOFException.
     * @throws java.io.EOFException thrown when this method is called after it returned -1 once.
     */
...
//        System.err.print((char)streamBuffer[sbIndex]);
    ...
    private int next6bits() throws IOException {
        ...
        if (hardEOF)
            ...
            throw new EOFException("All Hqx7 data was read and a soft EOF was already "
        ...
        do {
            ...
            if (b == -1)
                ...
                throw new EOFException("EOF reached before closing : character. "
        ...
        if (v == invalidEntry)
            ...
            throw new IOException("Illegal character in Hqx7 stream encountered, "
