...
class cart{
    ...
    public function process_orders($id,$code,$testing=false,$redirect=null){
    	...
    	$query = "SELECT * FROM invoices where id >= 11681 and DATE_ADD(curdate(), INTERVAL -5 DAY)<invoice_date order by id asc";
		$rs1 = mysql_query($query);
		echo mysql_num_rows($rs1);
		$c = 0;
		$items = array(	'HIS8'=>'66621300002',
						'HERS8'=>'66621300001',
						'COND8'=>'66621300003',
						'NBG8'=>"66621300009",
						'HIS1'=>'66621300006',
