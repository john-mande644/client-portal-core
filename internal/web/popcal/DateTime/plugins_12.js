...
var _separator_time = " ";
// the seperator char between the date and time.
var _scrollTime = 200;
// scrolling interval time in milliseconds
var _inc = 5;
// incremental time interval in minutes
var _timeVal;

function time2str(hour, minute, ampm) {
...
function formatTime(str) {
    if (/^([0]?[1-9]|1[0-2]):[0-5]?[0-9](am|pm)$/.test(str) == false) { // use current time if str is invalid
        ...
        return time2str(h, nd.getMinutes(), ampmSign);
    } else
        return str;
}
...
// Other Settings
var _highlite_background = "#D4D0C8";
// highlight background color
var _highlite_fontColor = "white";
// highlight font color
var _pop_length = 7;
// how many months to be shown
var _pop_width = 100;
// pixels of the popup width
...
function fSetDPop(y, m) {
    ...
    // menu-item focus background-color
    var padstr = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
