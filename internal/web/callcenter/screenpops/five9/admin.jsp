...
<style type="text/css">
    @import "http://ajax.googleapis.com/ajax/libs/dojo/1.7/dijit/themes/soria/soria.css";
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/dojo/1.7/dojo/dojo.js" djConfig="parseOnLoad:true, isDebug:false"></script>
...
<div dojoType="dijit.form.DropDownButton">
    <span><s:property value="%{ccClient.urlEntryName}"/></span>


    <div dojoType="dijit.TooltipDialog" id="tooltipOrder" title="Edit <s:property value="%{ccClient.urlEntryName}"/> Link">
        <table>
            <tr>
            ...
            <tr>
                                                            <td><label for="urlentryname">Url Name:</label></td>
                                                            <td><input dojoType="dijit.form.TextBox" style="width:200px;" type="text"
                                                                       id="urlentryname" name="ccClient.urlEntryName"
                                                            value="<s:property value="%{ccClient.urlEntryName}"/>"/></td>
                                                        </tr>
            <tr>
                <td>
                    <button dojoType="dijit.form.Button" name="Save" onclick="
                    dojo.byId('update_ccClient_urlEntry').value = dijit.byId('order').value;
                     dojo.byId('update_ccClient_urlEntryName').value = dijit.byId('urlentryname').value;
                    ">Save
...
<!-- orderstatus link-->
<div dojoType="dijit.form.DropDownButton">
    <span><s:property value="%{ccClient.urlStatusName}"/></span>


    <div dojoType="dijit.TooltipDialog" id="tooltipOrderStatus" title="Edit <s:property value="%{ccClient.urlStatusName}"/> Link">
        <table>
            <tr>
            ...
            <tr>
                                                 <td><label for="urlstatusname">Url Name:</label></td>
                                                 <td><input dojoType="dijit.form.TextBox" style="width:200px;" type="text"
                                                            id="urlstatusname" name="ccClient.urlStatusName"
                                                 value="<s:property value="%{ccClient.urlStatusName}"/>"/></td>
                                             </tr>
            <tr>
                <td>
                    <button dojoType="dijit.form.Button" name="Save" onclick="
                    dojo.byId('update_ccClient_urlStatus').value = dijit.byId('orderstatus').value;
                    dojo.byId('update_ccClient_urlStatusName').value = dijit.byId('urlstatusname').value;
                    ">Save
                    </button>
                </td>
                <td>
...
<div dojoType="dijit.form.DropDownButton">
    <span><s:property value="%{ccClient.urlServiceName}"/></span>


    <div dojoType="dijit.TooltipDialog" id="tooltipCustomerService" title="Edit <s:property value="%{ccClient.urlServiceName}"/> Link">
        <table>
            <tr>
            ...
            <tr>
                                      <td><label for="urlservicename">Url Name:</label></td>
                                      <td><input dojoType="dijit.form.TextBox" style="width:200px;" type="text"
                                                 id="urlservicename" name="ccClient.urlServiceName"
                                      value="<s:property value="%{ccClient.urlServiceName}"/>"/></td>
                                  </tr>
            <tr>
                <td>
                    <button dojoType="dijit.form.Button" name="Save" onclick="
                    dojo.byId('update_ccClient_urlService').value = dijit.byId('customerservice').value;
                     dojo.byId('update_ccClient_urlServiceName').value = dijit.byId('urlservicename').value;">Save
                    </button>
                </td>
                <td>
                    <button dojoType="dijit.form.Button" type="submit" name="close">Close</button>
...
<div dojoType="dijit.form.DropDownButton">
    <span><s:property value="%{ccClient.urlQuickRefName}"/></span>


    <div dojoType="dijit.TooltipDialog" id="tooltipQuickRef" title="Edit <s:property value="%{ccClient.urlQuickRefName}"/> Link">
        <table>
            <tr>
            ...
            <tr>
                           <td><label for="urlquickrefname">Url Name:</label></td>
                           <td><input dojoType="dijit.form.TextBox" style="width:200px;" type="text"
                                      id="urlquickrefname" name="ccClient.urlQuickRefName"
                           value="<s:property value="%{ccClient.urlQuickRefName}"/>"/></td>
                       </tr>
            <tr>
                <td>
                    <button dojoType="dijit.form.Button" name="Save" onclick="dojo.byId('update_ccClient_urlQuickRef').value =
                                    dijit.byId('quickref').value;
                                     dojo.byId('update_ccClient_urlQuickRefName').value = dijit.byId('urlquickrefname').value;
                                     ">Save
                    </button>
                </td>
                <td>
...
<div dojoType="dijit.layout.ContentPane"
    ...
    <s:form action="update" theme="simple">
        ...
        <s:hidden name="ccClient.urlEntryName"/>
        <s:hidden name="ccClient.urlStatusName"/>
        <s:hidden name="ccClient.urlServiceName"/>
        <s:hidden name="ccClient.urlQuickRefName"/>
...
<script type="text/javascript" src="http://internal.owd.com/tinymce/jscripts/tiny_mce/tiny_mce_dev.js"></script>
<script type="text/javascript">
