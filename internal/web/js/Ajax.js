...
//global variables
  ...
  //you may exclude alert


    //get the (form based) params to push up as part of the get request
    //url=url+getFormAsString(nameOfFormToPost);
    var parameters = getFormAsString(nameOfFormToPost);
    //Do the Ajax call
  ...
  function processStateChange() {
      ...
      if (req.status == 200) { // OK response
        ...
        replaceExistingWithNewHtml(spanElements);
         toggleVisibility('throb','hidden','hidden','hidden');
      } else {
...
function retrieveURLt(url,nameOfFormToPost,layer) {

  //you may exclude alert

     toggleVisibility('throb','show','visible','visible');
    //get the (form based) params to push up as part of the get request
    //url=url+getFormAsString(nameOfFormToPost);
    var parameters = getFormAsString(nameOfFormToPost);
    //Do the Ajax call
