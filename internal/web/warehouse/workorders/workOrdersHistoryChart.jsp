...
<%
    ...
    try {
        ...
        ResultSet rs = HibernateSession.getResultSet(HibernateFogbugzSession.currentSession(), new StringBuffer()
                .append("select p.sFullName as 'Assigned To', ")
                ...
                .append("where fopen=1 group by p.sFullName").toString());
        ...
        JFreeChart chart = ChartFactory.createPieChart3D("Active Work Orders by Assignee", // Title
                series,         // Dataset
                false,                     // Show legend
