...
public class DestinationLocationsResult  implements java.io.Serializable {
    ...
    private TestGSSMailer.ArrayOfString destinationLoc;
    ...
    public DestinationLocationsResult(
           ...
           TestGSSMailer.ArrayOfString destinationLoc) {
     ...
     */
    public TestGSSMailer.ArrayOfString getDestinationLoc() {
        return destinationLoc;
    }
     ...
     */
    public void setDestinationLoc(TestGSSMailer.ArrayOfString destinationLoc) {
        this.destinationLoc = destinationLoc;
    }
        ...
        _equals = true && 
            ...
            ((this.destinationLoc==null && other.getDestinationLoc()==null) || 
             (this.destinationLoc!=null &&
              this.destinationLoc.equals(other.getDestinationLoc())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDestinationLoc() != null) {
            _hashCode += getDestinationLoc().hashCode();
        }
