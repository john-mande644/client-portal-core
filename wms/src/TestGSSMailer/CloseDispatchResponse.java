...
public class CloseDispatchResponse  implements java.io.Serializable {
    private TestGSSMailer.CloseDispatchResult closeDispatchResult;

    public CloseDispatchResponse() {
    }

    public CloseDispatchResponse(
           TestGSSMailer.CloseDispatchResult closeDispatchResult) {
     ...
     */
    public TestGSSMailer.CloseDispatchResult getCloseDispatchResult() {
        return closeDispatchResult;
    }
     ...
     */
    public void setCloseDispatchResult(TestGSSMailer.CloseDispatchResult closeDispatchResult) {
        this.closeDispatchResult = closeDispatchResult;
    }
