...
public class LoadAndProcessPackageDataResponse  implements java.io.Serializable {
    private TestGSSMailer.LoadAndProcessPackageDataResponseLoadAndProcessPackageDataResult loadAndProcessPackageDataResult;

    public LoadAndProcessPackageDataResponse() {
    }

    public LoadAndProcessPackageDataResponse(
           TestGSSMailer.LoadAndProcessPackageDataResponseLoadAndProcessPackageDataResult loadAndProcessPackageDataResult) {
     ...
     */
    public TestGSSMailer.LoadAndProcessPackageDataResponseLoadAndProcessPackageDataResult getLoadAndProcessPackageDataResult() {
        return loadAndProcessPackageDataResult;
    }
     ...
     */
    public void setLoadAndProcessPackageDataResult(TestGSSMailer.LoadAndProcessPackageDataResponseLoadAndProcessPackageDataResult loadAndProcessPackageDataResult) {
        this.loadAndProcessPackageDataResult = loadAndProcessPackageDataResult;
    }
