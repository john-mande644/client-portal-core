...
public class GetAvailableReportsForDispatchResponse  implements java.io.Serializable {
    private TestGSSMailer.GetAvailableReportResult getAvailableReportsForDispatchResult;

    public GetAvailableReportsForDispatchResponse() {
    }

    public GetAvailableReportsForDispatchResponse(
           TestGSSMailer.GetAvailableReportResult getAvailableReportsForDispatchResult) {
     ...
     */
    public TestGSSMailer.GetAvailableReportResult getGetAvailableReportsForDispatchResult() {
        return getAvailableReportsForDispatchResult;
    }
     ...
     */
    public void setGetAvailableReportsForDispatchResult(TestGSSMailer.GetAvailableReportResult getAvailableReportsForDispatchResult) {
        this.getAvailableReportsForDispatchResult = getAvailableReportsForDispatchResult;
    }
