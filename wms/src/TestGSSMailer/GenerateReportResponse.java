...
public class GenerateReportResponse  implements java.io.Serializable {
    private TestGSSMailer.GenerateReportResult generateReportResult;

    public GenerateReportResponse() {
    }

    public GenerateReportResponse(
           TestGSSMailer.GenerateReportResult generateReportResult) {
     ...
     */
    public TestGSSMailer.GenerateReportResult getGenerateReportResult() {
        return generateReportResult;
    }
     ...
     */
    public void setGenerateReportResult(TestGSSMailer.GenerateReportResult generateReportResult) {
        this.generateReportResult = generateReportResult;
    }
