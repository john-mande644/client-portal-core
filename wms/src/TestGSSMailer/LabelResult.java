...
public class LabelResult  implements java.io.Serializable {
    ...
    private TestGSSMailer.ArrayOfBase64Binary label;
    ...
    public LabelResult(
           ...
           TestGSSMailer.ArrayOfBase64Binary label) {
     ...
     * @return label
     */
    public TestGSSMailer.ArrayOfBase64Binary getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(TestGSSMailer.ArrayOfBase64Binary label) {
        this.label = label;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.usps-cpas.com/usps-cpas/GSSAPI/", "ArrayOfBase64Binary"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
