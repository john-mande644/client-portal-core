...
public class TrackPackageResponse  implements java.io.Serializable {
    private TestGSSMailer.TrackResult trackPackageResult;

    public TrackPackageResponse() {
    }

    public TrackPackageResponse(
           TestGSSMailer.TrackResult trackPackageResult) {
     ...
     */
    public TestGSSMailer.TrackResult getTrackPackageResult() {
        return trackPackageResult;
    }
     ...
     */
    public void setTrackPackageResult(TestGSSMailer.TrackResult trackPackageResult) {
        this.trackPackageResult = trackPackageResult;
    }
