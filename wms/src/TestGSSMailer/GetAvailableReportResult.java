...
public class GetAvailableReportResult  implements java.io.Serializable {
    ...
    private TestGSSMailer.ArrayOfString report;
    ...
    public GetAvailableReportResult(
           ...
           TestGSSMailer.ArrayOfString report) {
     ...
     * @return report
     */
    public TestGSSMailer.ArrayOfString getReport() {
        return report;
    }
     ...
     * @param report
     */
    public void setReport(TestGSSMailer.ArrayOfString report) {
        this.report = report;
    }
