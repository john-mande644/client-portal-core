 ...
 */
public class loadCountAction  extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        try {
          countEditForm cf = (countEditForm) form;
            ...
            ResultSet rs = HibernateSession.getResultSet(HibernateSession.currentSession(), "SELECT     w_inv_locations.inventory_id, w_inv_locations.inventory_num, SUM(w_inv_counts.quanity) AS Quanity , COUNT(w_inv_locations.id) AS Enteries\n" +
                    ...
                    "GROUP BY w_inv_locations.inventory_id, w_inv_locations.inventory_num\n" +
                    "ORDER BY w_inv_locations.inventory_id");
