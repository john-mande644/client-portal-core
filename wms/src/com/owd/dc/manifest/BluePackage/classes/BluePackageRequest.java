...
public class BluePackageRequest {
    ...
    @Expose
    private Boolean commercialImporterFlag;
    @SerializedName("TotalMonthlyImportedWeight")
    @Expose
    private Integer totalMonthlyImportedWeight;
    @SerializedName("TotalMonthlyImportedValue")
    @Expose
    private Integer totalMonthlyImportedValue;
    ...
    public FreightShipment getFreightShipment() {
        return freightShipment;
    }

    public void setFreightShipment(FreightShipment freightShipment) {
    ...
    public Boolean getCommercialImporterFlag() {
        return commercialImporterFlag;
    }

    public void setCommercialImporterFlag(Boolean commercialImporterFlag) {
        this.commercialImporterFlag = commercialImporterFlag;
    }

    public Integer getTotalMonthlyImportedWeight() {
        return totalMonthlyImportedWeight;
    }

    public void setTotalMonthlyImportedWeight(Integer totalMonthlyImportedWeight) {
        this.totalMonthlyImportedWeight = totalMonthlyImportedWeight;
    }

    public Integer getTotalMonthlyImportedValue() {
        return totalMonthlyImportedValue;
    }

    public void setTotalMonthlyImportedValue(Integer totalMonthlyImportedValue) {
    ...
    public BluePackageRequest(){

    }

    public BluePackageRequest(AMPConnectShipShipment ship){
        try {
            this.setShipTo(new ShipTo(ship.getConsigneeNA()));
            this.setShipFrom(new ShipFrom(ship.getReturnNA()));
            this.setReturn(new Return(ship.getReturnNA()));
            this.setPackageList(new ArrayList<BluePackagePackage>());
            this.getPackageList().add(new BluePackagePackage(ship));
        }catch(Exception e){
