...
public class ScheelsAllSportsPackageLabel extends vendorCompliancePackageLabelBase {
    ...
    public static void main(String[] args) {
        ScheelsAllSportsPackageLabel label = new ScheelsAllSportsPackageLabel();
    ...
    public ScheelsAllSportsPackageLabel()
    {
    ...
    public List<String> getMultiLabelZPL(List<packageLabelDataBean> labelData)throws Exception{
        ...
        SPSCommerceZPLData zpl = sps.renderZPL(SPSCommerceLabelApiClient.LabelId_ScheelsAllSports, header, packs);
