...
public class MoosejawPackageLabel extends vendorCompliancePackageLabelBase {
    ...
    public static void main(String[] args) {
        MoosejawPackageLabel label = new MoosejawPackageLabel();
        String orderId = "23457535";
    ...
    public List<String> getMultiLabelZPL(List<packageLabelDataBean> labelData)throws Exception{
        ...
        SPSCommerceZPLData zpl = sps.renderZPL(SPSCommerceLabelApiClient.LabelId_Moosejaw, header, packs);
