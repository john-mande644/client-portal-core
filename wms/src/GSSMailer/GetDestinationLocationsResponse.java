...
public class GetDestinationLocationsResponse  implements java.io.Serializable {
    private GSSMailer.DestinationLocationsResult getDestinationLocationsResult;

    public GetDestinationLocationsResponse() {
    }

    public GetDestinationLocationsResponse(
           GSSMailer.DestinationLocationsResult getDestinationLocationsResult) {
     ...
     */
    public GSSMailer.DestinationLocationsResult getGetDestinationLocationsResult() {
        return getDestinationLocationsResult;
    }
     ...
     */
    public void setGetDestinationLocationsResult(GSSMailer.DestinationLocationsResult getDestinationLocationsResult) {
        this.getDestinationLocationsResult = getDestinationLocationsResult;
    }
