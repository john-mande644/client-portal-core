...
public class CloseReceptacleResponse  implements java.io.Serializable {
    private GSSMailer.CommonResult closeReceptacleResult;

    public CloseReceptacleResponse() {
    }

    public CloseReceptacleResponse(
           GSSMailer.CommonResult closeReceptacleResult) {
     ...
     */
    public GSSMailer.CommonResult getCloseReceptacleResult() {
        return closeReceptacleResult;
    }
     ...
     */
    public void setCloseReceptacleResult(GSSMailer.CommonResult closeReceptacleResult) {
        this.closeReceptacleResult = closeReceptacleResult;
    }
