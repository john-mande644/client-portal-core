...
public class LoadPackageData  implements java.io.Serializable {
    private GSSMailer.LoadPackageDataXmlDoc xmlDoc;
    ...
    public LoadPackageData(
           GSSMailer.LoadPackageDataXmlDoc xmlDoc,
     ...
     * @return xmlDoc
     */
    public GSSMailer.LoadPackageDataXmlDoc getXmlDoc() {
        return xmlDoc;
    }
     ...
     * @param xmlDoc
     */
    public void setXmlDoc(GSSMailer.LoadPackageDataXmlDoc xmlDoc) {
        this.xmlDoc = xmlDoc;
    }
