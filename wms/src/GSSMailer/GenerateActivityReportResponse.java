...
public class GenerateActivityReportResponse  implements java.io.Serializable {
    private GSSMailer.GenerateReportResult generateActivityReportResult;

    public GenerateActivityReportResponse() {
    }

    public GenerateActivityReportResponse(
           GSSMailer.GenerateReportResult generateActivityReportResult) {
     ...
     */
    public GSSMailer.GenerateReportResult getGenerateActivityReportResult() {
        return generateActivityReportResult;
    }
     ...
     */
    public void setGenerateActivityReportResult(GSSMailer.GenerateReportResult generateActivityReportResult) {
        this.generateActivityReportResult = generateActivityReportResult;
    }
