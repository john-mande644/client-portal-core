...
public class LoadAndRecordLabeledPackageResponse  implements java.io.Serializable {
    private GSSMailer.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult;

    public LoadAndRecordLabeledPackageResponse() {
    }

    public LoadAndRecordLabeledPackageResponse(
           GSSMailer.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult) {
     ...
     */
    public GSSMailer.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult getLoadAndRecordLabeledPackageResult() {
        return loadAndRecordLabeledPackageResult;
    }
     ...
     */
    public void setLoadAndRecordLabeledPackageResult(GSSMailer.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult) {
        this.loadAndRecordLabeledPackageResult = loadAndRecordLabeledPackageResult;
    }
