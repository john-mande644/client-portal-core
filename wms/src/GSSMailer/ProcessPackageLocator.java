...
public class ProcessPackageLocator extends org.apache.axis.client.Service implements GSSMailer.ProcessPackage {
 ...
 */
    ...
    private java.lang.String ProcessPackageSoap_address = "https://gss.usps.com/usps-cpas/GSSAPI/GSSMailerWebService.asmx";
    ...
    public GSSMailer.ProcessPackageSoap_PortType getProcessPackageSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            GSSMailer.ProcessPackageSoap_BindingStub _stub = new GSSMailer.ProcessPackageSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String ProcessPackageSoap12_address = "https://gss.usps.com/usps-cpas/GSSAPI/GSSMailerWebService.asmx";
    ...
    public GSSMailer.ProcessPackageSoap_PortType getProcessPackageSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            GSSMailer.ProcessPackageSoap12Stub _stub = new GSSMailer.ProcessPackageSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (GSSMailer.ProcessPackageSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                GSSMailer.ProcessPackageSoap_BindingStub _stub = new GSSMailer.ProcessPackageSoap_BindingStub(new java.net.URL(ProcessPackageSoap_address), this);
                _stub.setPortName(getProcessPackageSoapWSDDServiceName());
                return _stub;
            }
            if (GSSMailer.ProcessPackageSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                GSSMailer.ProcessPackageSoap12Stub _stub = new GSSMailer.ProcessPackageSoap12Stub(new java.net.URL(ProcessPackageSoap12_address), this);
                _stub.setPortName(getProcessPackageSoap12WSDDServiceName());
                return _stub;
            }
        }
