...
public class TrackPackageResponse  implements java.io.Serializable {
    private GSSMailer.TrackResult trackPackageResult;

    public TrackPackageResponse() {
    }

    public TrackPackageResponse(
           GSSMailer.TrackResult trackPackageResult) {
     ...
     */
    public GSSMailer.TrackResult getTrackPackageResult() {
        return trackPackageResult;
    }
     ...
     */
    public void setTrackPackageResult(GSSMailer.TrackResult trackPackageResult) {
        this.trackPackageResult = trackPackageResult;
    }
