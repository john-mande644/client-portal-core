...
public class CloseDispatchResponse  implements java.io.Serializable {
    private GSSMailer.CloseDispatchResult closeDispatchResult;

    public CloseDispatchResponse() {
    }

    public CloseDispatchResponse(
           GSSMailer.CloseDispatchResult closeDispatchResult) {
     ...
     */
    public GSSMailer.CloseDispatchResult getCloseDispatchResult() {
        return closeDispatchResult;
    }
     ...
     */
    public void setCloseDispatchResult(GSSMailer.CloseDispatchResult closeDispatchResult) {
        this.closeDispatchResult = closeDispatchResult;
    }
