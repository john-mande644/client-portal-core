...
public class GenerateReportResponse  implements java.io.Serializable {
    private GSSMailer.GenerateReportResult generateReportResult;

    public GenerateReportResponse() {
    }

    public GenerateReportResponse(
           GSSMailer.GenerateReportResult generateReportResult) {
     ...
     */
    public GSSMailer.GenerateReportResult getGenerateReportResult() {
        return generateReportResult;
    }
     ...
     */
    public void setGenerateReportResult(GSSMailer.GenerateReportResult generateReportResult) {
        this.generateReportResult = generateReportResult;
    }
