...
public class CloseDispatchToDestinationLocationResponse  implements java.io.Serializable {
    private GSSMailer.CloseDispatchResult closeDispatchToDestinationLocationResult;

    public CloseDispatchToDestinationLocationResponse() {
    }

    public CloseDispatchToDestinationLocationResponse(
           GSSMailer.CloseDispatchResult closeDispatchToDestinationLocationResult) {
     ...
     */
    public GSSMailer.CloseDispatchResult getCloseDispatchToDestinationLocationResult() {
        return closeDispatchToDestinationLocationResult;
    }
     ...
     */
    public void setCloseDispatchToDestinationLocationResult(GSSMailer.CloseDispatchResult closeDispatchToDestinationLocationResult) {
        this.closeDispatchToDestinationLocationResult = closeDispatchToDestinationLocationResult;
    }
