...
public class TrackPackageWithPostalCodeResponse  implements java.io.Serializable {
    private GSSMailer.TrackingWithPostalCodeResult trackPackageWithPostalCodeResult;

    public TrackPackageWithPostalCodeResponse() {
    }

    public TrackPackageWithPostalCodeResponse(
           GSSMailer.TrackingWithPostalCodeResult trackPackageWithPostalCodeResult) {
     ...
     */
    public GSSMailer.TrackingWithPostalCodeResult getTrackPackageWithPostalCodeResult() {
        return trackPackageWithPostalCodeResult;
    }
     ...
     */
    public void setTrackPackageWithPostalCodeResult(GSSMailer.TrackingWithPostalCodeResult trackPackageWithPostalCodeResult) {
        this.trackPackageWithPostalCodeResult = trackPackageWithPostalCodeResult;
    }
