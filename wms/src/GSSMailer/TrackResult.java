...
public class TrackResult  implements java.io.Serializable {
    ...
    private GSSMailer.TrackingEvent[] trackingEvent;
    ...
    public TrackResult(
           ...
           GSSMailer.TrackingEvent[] trackingEvent) {
     ...
     */
    public GSSMailer.TrackingEvent[] getTrackingEvent() {
        return trackingEvent;
    }
     ...
     * @param trackingEvent
     */
    public void setTrackingEvent(GSSMailer.TrackingEvent[] trackingEvent) {
        this.trackingEvent = trackingEvent;
    }
