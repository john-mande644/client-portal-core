...
public class OpenReceptacleResponse  implements java.io.Serializable {
    private GSSMailer.CommonResult openReceptacleResult;

    public OpenReceptacleResponse() {
    }

    public OpenReceptacleResponse(
           GSSMailer.CommonResult openReceptacleResult) {
     ...
     */
    public GSSMailer.CommonResult getOpenReceptacleResult() {
        return openReceptacleResult;
    }
     ...
     */
    public void setOpenReceptacleResult(GSSMailer.CommonResult openReceptacleResult) {
        this.openReceptacleResult = openReceptacleResult;
    }
