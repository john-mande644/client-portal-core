...
<span class="label">How Many Packages<br></span>

<table>
<html:form action="doneWithReceive" >
<html:text property="cartonCount" size="10" styleId="autoSubmit"/>
<html:hidden property="rcvId"/>
<tr><td><html:submit property="submit"><bean:message key="button.enterPackages"/></html:submit></td>
</html:form>
</table>
<br>
</div>
