...
<span class="label">Scan Location to Clear</span>
<HR ALIGN="center" SIZE="1" >
<font color = red>Warning, this will clear all records of this location for all inventory. Use ONLY if you are sure!</font>
 <html:form action="clearlocation" focus="location">
<bean:message key="label.locations.clear"/><br>
