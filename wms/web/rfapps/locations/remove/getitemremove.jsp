...
<table border="0" width="180" cellspacing="0" cellpadding="0" frame="box">
<tr><td valign=top  >
<span class="label"><font color=red>Remove</font> Item From Location: <c:out value='${loc}'/></span>
<HR ALIGN="center" SIZE="1" >

<html:form action="removebatchlocation" focus="sku">
...
<html:form action="remove"><html:submit><bean:message key="button.setnewlocation"/></html:submit></html:form>
