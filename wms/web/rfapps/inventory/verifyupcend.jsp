...
<b><font size=+1><bean:message key="text.upcverifyfinish"/></font></b><br>
...
<html:form action="upcVerifyFinish" focus="barcode">
<bean:message key="label.upc.verifyfinish"/><br>
<html:text property="barcode" value="" styleId="autoSubmit"/><br>
<html:hidden property="invID" value="${skuinfo.inventoryId}"/>
<html:submit><bean:message key="button.upcverify"/></html:submit>
</html:form>

<HR ALIGN="center" SIZE="1" >
<html:form action="verifyupc"><html:submit><bean:message key="button.cancel"/></html:submit></html:form>
</td></tr></table>
</div></body>
