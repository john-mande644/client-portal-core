...
<tr><td valign=top  >
<span class="label">Scan Inventory Count Request</span><br>
<HR ALIGN="center" SIZE="1" >
<html:form action="inventorystart" focus="sku">
<bean:message key="label.inentory.start"/><br>
...
<html:form action="inventoryRequestStart">
