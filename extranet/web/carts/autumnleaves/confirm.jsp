...
<%
    AutumnLeavesCart cart = (com.owd.web.carts.autumnleaves.AutumnLeavesCart) request.getSession(true).getAttribute(AutumnLeavesServlet.kCartKey);
...
{
%>
<TR><td colspan=5><font color="red" face="Geneva, Verdana, Helvetica"><%= request.getAttribute(AutumnLeavesServlet.kCartError)%><P> </font></TD></TR>
<%
}
%>
...
/* <![CDATA[ */
var google_conversion_id = 1023045073;
var google_conversion_language = "en";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "11G_CMfm3AEQ0dvp5wM";
var google_conversion_value = 0;
if (<%=decform.format(order.total_order_cost)%>) {
  google_conversion_value = <%=decform.format(order.total_order_cost)%>;
}
/* ]]> */
</script>
...
<img height="1" width="1" style="border-style:none;" alt="" src="https://www.googleadservices.com/pagead/conversion/1023045073/?value=<%=decform.format(order.total_order_cost)%>&amp;label=11G_CMfm3AEQ0dvp5wM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
