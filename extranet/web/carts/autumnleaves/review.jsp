...
AutumnLeavesCart cart = null;
Order order = null;
try{
	  cart = (AutumnLeavesCart) request.getSession(true).getAttribute(AutumnLeavesServlet.kCartKey);
	order = cart.getOrder();
...
<div id="cart">
<FORM ACTION="/carts/autumnleaves/autumnleaves.jsp" METHOD="POST">
...
{
%>
<TR><td colspan=5><font color="red" face="Geneva, Verdana, Helvetica" size="+1"><%= request.getAttribute(AutumnLeavesServlet.kCartError)%><P> </font></TD></TR>
<%
}
%>
 <tr>
...
<tr>
  ...
  <td COLSPAN=4 ALIGN="RIGHT" NOWRAP><font size="-1" face="Geneva, Verdana, Helvetica"><B>Standard Shipping</B></TD><TD ALIGN=RIGHT><font size="-1" face="Geneva, Verdana, Helvetica"><B>&nbsp;&nbsp;&nbsp;&nbsp;$ <%=decform.format(order.total_shipping_cost)%></B></td>
</tr>
<tr>
...
<tr>
    <td colspan=2 align=left valign="top"><font size="-1" face="Geneva, Verdana, Helvetica">Review your order summary above to ensure accurate delivery.</font></td>
  <td align=right valign="center">
<font size="-1" face="Geneva, Verdana, Helvetica">
<INPUT TYPE=HIDDEN NAME=cd VALUE=447><INPUT TYPE=HIDDEN NAME=do VALUE=6>
