...
var gsNavPrev="<A href='javascript:void(0)' class='MonthNav' onclick='if(this.blur)this.blur();fPrevMonth();return false;' onmouseover='return true;'><IMG src='arrowl.gif' width='6' height='10' border='0' alt=''></A>";	// the content of the left month navigator
var gsNavNext="<A href='javascript:void(0)' class='MonthNav' onclick='if(this.blur)this.blur();fNextMonth();return false;' onmouseover='return true;'><IMG src='arrowr.gif' width='6' height='10' border='0' alt=''></A>";	// the content of the right month navigator

var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='Today' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You may not pick this day!\");return false;' onmouseover='return true;' title='Today'>Today</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
...
var gAgendaMask=[-1,-1,gcCellBG,"black",null,false,null];	// Set the relevant bit to -1 to keep the original agenda info of that bit unchanged, otherwise the new value will substitute the one defined in agenda.js.
