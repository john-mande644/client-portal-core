...
private final static Logger log =  LogManager.getLogger();
    ...
    public String getManagerMenus(HttpServletRequest req) {
        ...
        sb.append("<UL><LI><A HREF=\"" + ExtranetServlet.kExtranetURLPath + "?" + kParamSupplierMgrAction + "=" + kParamSupplierExploreAction + "\" >");

        sb.append("Explore Suppliers");

        sb.append("<LI><A HREF=\"" + ExtranetServlet.kExtranetURLPath + "?" + kParamSupplierMgrAction + "=" + kParamSupplierExploreAction + "\" >");
    ...
    public void getManagerContent(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (currAction.equals(kParamSupplierExploreAction)) {
            ...
            try {
                req.getRequestDispatcher(ExtranetServlet.kExtranetJSPPath + "findsupplier.jsp").include(req, resp);
            } catch (Exception ex2) {

                ex2.printStackTrace();

                com.owd.core.Mailer.postMailMessage("Explore Suppliers redirect error", ex2.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex2), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                ...
                com.owd.core.Mailer.postMailMessage("Create Suppliers error", ex.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                req.getRequestDispatcher(ExtranetServlet.kExtranetJSPPath + "editsupplier.jsp").include(req, resp);
            } catch (Exception ex2) {

                ex2.printStackTrace();

                com.owd.core.Mailer.postMailMessage("Create Suppliers redirect error", ex2.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex2), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                ...
                com.owd.core.Mailer.postMailMessage("Edit Suppliers error", ex.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                ...
                com.owd.core.Mailer.postMailMessage("Edit Suppliers redirect error", ex2.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex2), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                ...
                com.owd.core.Mailer.postMailMessage("Save Supplier error", ex.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                ...
                com.owd.core.Mailer.postMailMessage("Save Supplier redirect error", ex2.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex2), "owditadmin@owd.com", "owditadmin@owd.com");
            ...
            try {
                ...
                com.owd.core.Mailer.postMailMessage("Suppliers catch error", ex2.getMessage() + "\n" + com.owd.core.OWDUtilities.getStackTraceAsString(ex2), "owditadmin@owd.com", "owditadmin@owd.com");
    ...
    public String[] getManagerActions(HttpServletRequest req) {
        ...
        urls[0] = "<A class=\"command\" HREF=\"" + ExtranetServlet.kExtranetURLPath + "?" + kParamSupplierMgrAction + "=" + kParamSupplierExploreAction + "\" >Search</A>";

        urls[1] = "<A class=\"command\" HREF=\"" + ExtranetServlet.kExtranetURLPath + "?" + kParamSupplierMgrAction + "=" + kParamSupplierCreateAction + "\" >Create New Supplier</A>";
