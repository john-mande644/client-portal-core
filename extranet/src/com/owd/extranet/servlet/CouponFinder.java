...
private final static Logger log =  LogManager.getLogger();
	...
	String[] tableLinkStarts = {ExtranetServlet.kParamAdminAction+"="+ExtranetServlet.kParamChangeMgrAction +"&"+ ExtranetServlet.kParamChangeMgrTo+"="+ ExtranetManager.kCouponsMgrName+"&"+CouponManager.kParamCouponMgrAction+"="+CouponManager.kParamCouponEditAction+"&"+CouponManager.kparamCouponID+"=","","","","","",""};
			...
			{gotSearch = true;
...

				{
					...
					case kIsType:
						...
						table.addCriterium("(exp_date >= \""+ OWDUtilities.getSQLDateTimeForToday()+"\")");
					...
					case kInType:
						...
						table.addCriterium("(exp_date < \""+OWDUtilities.getSQLDateTimeForToday()+"\" OR (used_count >= use_limit AND use_limit > 0))");
