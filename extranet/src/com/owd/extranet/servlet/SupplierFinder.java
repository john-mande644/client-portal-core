...
private final static Logger log =  LogManager.getLogger();
		...
		String[] tableLinkStarts = {ExtranetServlet.kParamAdminAction+"="+ExtranetServlet.kParamChangeMgrAction +"&"+ ExtranetServlet.kParamChangeMgrTo+"="+ ExtranetManager.kSuppliersMgrName+"&"+SupplierManager.kParamSupplierMgrAction+"="+SupplierManager.kParamSupplierEditAction+"&"+SupplierManager.kparamSupplierID+"=","","","",""};
