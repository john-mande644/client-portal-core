/**
 * SettlementOperationResponse.java
 *
...
public class SettlementOperationResponse  implements java.io.Serializable {
    private com.owd.onestop.OperationResponseStatus operationResponseStatus;

    public SettlementOperationResponse() {
    }
    ...
    /**
     * Gets the operationResponseStatus value for this SettlementOperationResponse.
     * 
    ...
    /**
     * Sets the operationResponseStatus value for this SettlementOperationResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SettlementOperationResponse)) return false;
        SettlementOperationResponse other = (SettlementOperationResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SettlementOperationResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Onestop.Api.Services", "SettlementOperationResponse"));
