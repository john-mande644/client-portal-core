...
public final class DomestifyDuoplaneOrdersImportJob extends OWDStatefulJob implements OrderProcessingResultsHandler {
    private final static int kClientID = 682;
    private final static Logger log = LogManager.getLogger();
    private String status = "";
    SftpConnector ftp = new SftpConnector("ftp.owd.com", "domestify", "dmstfy2021", "ftp", "aes128-ctr,aes128-cbc");
    ...
    int kOrder_Date = 15;
    int kOrder_Retailer = 16; // Domestify sends group name in Retailer field
    ...
    public void internalExecute() {
        try {
            ...
            if (System.getProperty("com.owd.environment") == "test" ){
            ...
            for (String file : fileNames) {
                DelimitedFileOrderHandler fileHandler = new DelimitedFileOrderHandler(this, kClientID, new DelimitedReader('|', new BufferedReader(new StringReader(ftp.getFileData(file).toString())), true), file) {
                    ...
                    public Order loadOrder(Order order, int orderIndex) throws Exception {
                        ...
                        for (int row = data.rowIndexStart; row < (data.rowIndexStart + data.rowsForOrder); row++) {
                            ...
                            if (row == data.rowIndexStart) {
                                ...
                                // 1138645
                                if(order.total_product_cost>=75f){
                            ...
                            // 1226744 - Ship third party if SKU is in list specified by Domestify
                            // 1260233 - Additional DM ship skus
                            // 1310008 - Add RTC-MC6 SKU
                            List<String> domestify_ups_skus = new ArrayList<>(Arrays.asList("57920","M0770","M0980","K7651","M0981","L9590","L1080","L0741","KL4159","10001","820402RD","FLO-26X45-BL","CAIRO-26X45","EM1790","EM7665","EM8043","EM7782","EM7415","EM7897","EM7090","EM9949","EM2963","EM7087","EM7039","EM2341","EM1014","EM7641","EM9950","EM7283","4424","4363","F-981","II-298","ZIPBROOM","SKSTRET2PK","FLIPTORET","JB8450RED","JB8670","JB7686-BRN","JB8671","JB7686-GRN","JB5545","JB7488","FLO-3PC-GN","FLO-20X90-BU","OPT-3PC-SET","DLB25LEGR","DELB25LE8GR","1526","8541","8538","1227","9080","PCL-10","VOWR-2","PCL-12","PCN-10","580470","DGF","MBC-6","DGCL-12","CCP-2040","50-1040","50-5070","BW000053-002","2PGVP4","JB8450RED","H-000BMCPB-Poly","CC-1001","NZ-1001","RTB-MC6"));

                            if (order.containsAnySKU(domestify_ups_skus)){
                                log.debug("Shipping 3rd Party - Contain only domestify SKUs");
                                order.getShippingInfo().setShipOptions("UPS Ground", "Third Party Billing", "160E19");
                    ...
                    public void translateShipMethod(Order order, String oldMethod) throws Exception {
                        ...
                        if (oldMethod.equals("Ground")) {
                            order.getShippingInfo().setShipOptions("Ground", "Prepaid", "");
                        }
                    }
