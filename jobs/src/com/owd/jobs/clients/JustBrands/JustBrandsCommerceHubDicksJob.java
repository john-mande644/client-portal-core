 ...
 */
public class JustBrandsCommerceHubDicksJob extends OWDStatefulJob {
    ...
    public void internalExecute() {
        ...
        try {
            ...
            ex.printStackTrace();
            Exception exl = new LogableException(ex, "Generic order import error from BedBath:" + ex.getMessage(), "TS:" + Calendar.getInstance().getTimeInMillis(), "626", "Dicks", LogableException.errorTypes.ORDER_IMPORT);
