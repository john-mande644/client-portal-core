...
/**
 * <p>Java class for contactFieldRestrictionType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="contactFieldRestrictionType">
 ...
 * 
 */
@XmlType(name = "contactFieldRestrictionType")
@XmlEnum
public enum ContactFieldRestrictionType {
    ...
    ContactFieldRestrictionType(String v) {
        value = v;
    }
    ...
    public static ContactFieldRestrictionType fromValue(String v) {
        for (ContactFieldRestrictionType c: ContactFieldRestrictionType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
