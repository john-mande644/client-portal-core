...
private final static Logger log =  LogManager.getLogger();
    ...
    public static String httpBuildQuery(Map<String, Object> params, String encoding) {
        ...
        for (Map.Entry<String, Object> entry : params.entrySet()) {
            ...
            if (value instanceof Map) {
                ...
                if(!(name.equals(""))) {baseParam.add(name);  }
    ...
    private static String buildUrlFromMap(List<String> baseParam, Map<Object, Object> map, String encoding) {
        ...
        for (Map.Entry<Object, Object> entry : map.entrySet()) {
            ...
            if (value instanceof Map) {
                ...
                log.debug("encoding "+name+" for baseparam="+getBaseParamString(baseParam));

                token = getBaseParamString(baseParam) + encodeParam("[" + name + "]")+"=" + encodeParam(value);
                sb.append(token);
            }
        }
    ...
    private static String buildUrlFromCollection(List<String> baseParam, Collection coll, String encoding) {
        ...
        for (int i = 0; i < arrColl.size(); i++) {
            ...
            if (value instanceof Map) {
                ...
                log.debug("encoding "+i+" for baseparam="+getBaseParamString(baseParam));
                token = getBaseParamString(baseParam) +encodeParam("[" + i + "]")+"="  + encodeParam(value);
                sb.append(token);
            }
        }
    ...
    private static String getBaseParamString(List<String> baseParam) {
        ...
        for (int i = 0; i < baseParam.size(); i++) {
            ...
            if (i == 0) {
                sb.append(s);
                log.debug("adding direct value "+s);
            } else {
                log.debug("encoding param ["+s);
                sb.append(encodeParam("[" + s + "]"));
            }
        }
        return sb.toString();
    }
...
/* ========================================================================= */
    ...
    private static void basicTest() {
        ...
        log.debug(httpBuildQuery(params, "UTF-8"));
    }
