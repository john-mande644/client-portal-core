...
public class WeeklyClientBillingReportDefinition extends MonthlyReportDefinition {

    public WeeklyClientBillingReportDefinition(int clientId, String customerName) {
        try {
            Date firstSaturday;
            Date lastSaturday;
