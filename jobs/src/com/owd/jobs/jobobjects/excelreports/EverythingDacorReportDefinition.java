 ...
 */
public class EverythingDacorReportDefinition extends MonthlyReportDefinition {



    public EverythingDacorReportDefinition(Date firstDatePastPeriod, Date firstDateOfPreviousMonth) {

        super(firstDatePastPeriod,firstDateOfPreviousMonth);
    }

    public EverythingDacorReportDefinition() {
        
        super();


        clientName = "Everything Dacor";
        SheetDefinition sheet = new SheetDefinition();
        sheet.clientFkey=346;
