...
public class AdditionalAccountType
{
    ...
    @XmlElement(name = "Currency", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
    protected CurrencyCodeType currency;
    @XmlElement(name = "AccountCode", namespace = "urn:ebay:apis:eBLBaseComponents", required = true)
