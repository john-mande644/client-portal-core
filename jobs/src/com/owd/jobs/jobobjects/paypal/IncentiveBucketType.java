...
@XmlType(name = "IncentiveBucketType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
        "items",
        "bucketId",
        "sellerId",
        "externalSellerId",
...
public class IncentiveBucketType
{
    ...
    @XmlElement(name = "Items", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ExternalSellerId", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String externalSellerId;
    @XmlElement(name = "BucketSubtotalAmt", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BasicAmountType bucketSubtotalAmt;
    @XmlElement(name = "BucketShippingAmt", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BasicAmountType bucketShippingAmt;
    @XmlElement(name = "BucketInsuranceAmt", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BasicAmountType bucketInsuranceAmt;
    @XmlElement(name = "BucketSalesTaxAmt", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected BasicAmountType bucketSalesTaxAmt;
    @XmlElement(name = "BucketTotalAmt", namespace = "urn:ebay:apis:eBLBaseComponents")
