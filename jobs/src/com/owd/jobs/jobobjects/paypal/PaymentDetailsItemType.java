...
@XmlType(name = "PaymentDetailsItemType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
        "name",
        "number",
        "quantity",
        "tax",
...
public class PaymentDetailsItemType
{
    ...
    @XmlElement(name = "EbayItemPaymentDetailsItem", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected EbayItemPaymentDetailsItemType ebayItemPaymentDetailsItem;
    @XmlElement(name = "PromoCode", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ItemWeight", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MeasureType itemWeight;
    @XmlElement(name = "ItemLength", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MeasureType itemLength;
    @XmlElement(name = "ItemWidth", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MeasureType itemWidth;
    @XmlElement(name = "ItemHeight", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected MeasureType itemHeight;
    @XmlElement(name = "ItemURL", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected String itemURL;
    @XmlElement(name = "EnhancedItemData", namespace = "urn:ebay:apis:eBLBaseComponents")
