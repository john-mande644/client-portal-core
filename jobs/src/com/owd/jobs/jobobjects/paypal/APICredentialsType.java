...
@XmlType(name = "APICredentialsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
        "username",
        "password",
        "signature",
        "certificate",
...
public class APICredentialsType
{
    ...
    @XmlElement(name = "Certificate", namespace = "urn:ebay:apis:eBLBaseComponents")
