...
@XmlType(name = "DoNonReferencedCreditRequestDetailsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
        "amount",
        "netAmount",
        "taxAmount",
        "shippingAmount",
...
public class DoNonReferencedCreditRequestDetailsType
{
    ...
    @XmlElement(name = "NetAmount", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ReceiverEmail", namespace = "urn:ebay:apis:eBLBaseComponents")
