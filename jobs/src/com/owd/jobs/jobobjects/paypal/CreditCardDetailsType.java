...
@XmlType(name = "CreditCardDetailsType", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
        "creditCardType",
        "creditCardNumber",
        "expMonth",
        "expYear",
...
public class CreditCardDetailsType
{
    ...
    @XmlElement(name = "CreditCardType", namespace = "urn:ebay:apis:eBLBaseComponents")
    protected CreditCardTypeType creditCardType;
    @XmlElement(name = "CreditCardNumber", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "CardOwner", namespace = "urn:ebay:apis:eBLBaseComponents")
    ...
    @XmlElement(name = "ThreeDSecureRequest", namespace = "urn:ebay:apis:eBLBaseComponents")
