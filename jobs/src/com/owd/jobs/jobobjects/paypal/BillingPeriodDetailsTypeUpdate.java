...
@XmlType(name = "BillingPeriodDetailsType_Update", namespace = "urn:ebay:apis:eBLBaseComponents", propOrder = {
        "billingPeriod",
        "billingFrequency",
        "totalBillingCycles",
        "amount",
...
public class BillingPeriodDetailsTypeUpdate
{
    ...
    @XmlElement(name = "BillingPeriod", namespace = "urn:ebay:apis:eBLBaseComponents")
