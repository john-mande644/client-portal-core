...
import com.owd.jobs.jobobjects.spscommerce.clients.JustBrandsOnyxEDI
import org.junit.Test

/**
 * Created by danny on 1/30/2017.
 */
class JustBrandsOnyxTesting extends GroovyTestCase {
    ...
    void test1Onyx() {
        ...
        String poData = "<Order>\n" +
                ...
                "        <InterchangeControlNumber>000000002</InterchangeControlNumber>\n" +
                "        <GroupControlNumber>000000002</GroupControlNumber>\n" +
                "        <DocumentControlNumber>000000002</DocumentControlNumber>\n" +
                "        <InterchangeSenderID>ONYXENTR</InterchangeSenderID>\n" +
                "        <InterchangeReceiverID>4147638998</InterchangeReceiverID>\n" +
                "        <GroupSenderID>ONYXENTR</GroupSenderID>\n" +
                "        <GroupReceiverID>4147638998</GroupReceiverID>\n" +
                "    </Meta>\n" +
                "    <Header>\n" +
                "        <OrderHeader>\n" +
                "            <TradingPartnerId>CQKALLJUSTBRAND</TradingPartnerId>\n" +
                "            <PurchaseOrderNumber>40000042-1I1KE0</PurchaseOrderNumber>\n" +
                "            <TsetPurposeCode>00</TsetPurposeCode>\n" +
                "            <PurchaseOrderTypeCode>DS</PurchaseOrderTypeCode>\n" +
                "            <PurchaseOrderDate>2019-05-09</PurchaseOrderDate>\n" +
                "            <Vendor>48952133</Vendor>\n" +
                "        </OrderHeader>\n" +
                "        <PaymentTerms>\n" +
                ...
                "            <Date1>2019-05-09</Date1>\n" +
                "        </Date>\n" +
                "        <Address>\n" +
                "            <AddressTypeCode>ST</AddressTypeCode>\n" +
                "            <AddressName>TOM MACKIN</AddressName>\n" +
                "            <Address1>4161 HWY. 21</Address1>\n" +
                "            <Address2>P.O. BOX 539</Address2>\n" +
                "            <City>IDAHO CITY</City>\n" +
                "            <State>ID</State>\n" +
                "            <PostalCode>83631</PostalCode>\n" +
                "            <Country>US</Country>\n" +
                "            <Contact>\n" +
                "                <ContactTypeCode>OC</ContactTypeCode>\n" +
                "                <ContactName>TOM MACKIN</ContactName>\n" +
                "                <PrimaryPhone>208-297-9653</PrimaryPhone>\n" +
                "            </Contact>\n" +
                "        </Address>\n" +
                "        <CarrierInformation>\n" +
                "            <CarrierAlphaCode>1454</CarrierAlphaCode>\n" +
                "            <CarrierRouting>USPS Priority Mail</CarrierRouting>\n" +
                "        </CarrierInformation>\n" +
                "    </Header>\n" +
                "    <LineItems>\n" +
                "        <LineItem>\n" +
                ...
                "                <BuyerPartNumber>AH-ZTOP-5V-W-G-L</BuyerPartNumber>\n" +
                "                <VendorPartNumber>AH-ZTOP-5V-W-G-L</VendorPartNumber>\n" +
                "                <OrderQty>1</OrderQty>\n" +
                "                <OrderQtyUOM>EA</OrderQtyUOM>\n" +
                "                <PurchasePrice>90</PurchasePrice>\n" +
                "            </OrderLine>\n" +
                "            <ProductOrItemDescription>\n" +
                "                <ItemDescriptionType>08</ItemDescriptionType>\n" +
                "                <ProductDescription>VENDOR DESCRIPTION</ProductDescription>\n" +
                "            </ProductOrItemDescription>\n" +
                "        </LineItem>\n" +
                "        <LineItem>\n" +
                "            <OrderLine>\n" +
                "                <LineSequenceNumber>2</LineSequenceNumber>\n" +
                "                <BuyerPartNumber>AH-HDY-5V-G-XXL</BuyerPartNumber>\n" +
                "                <VendorPartNumber>AH-HDY-5V-G-XXL</VendorPartNumber>\n" +
                "                <OrderQty>1</OrderQty>\n" +
                "                <OrderQtyUOM>EA</OrderQtyUOM>\n" +
                "                <PurchasePrice>199</PurchasePrice>\n" +
                "            </OrderLine>\n" +
                "            <ProductOrItemDescription>\n" +
                "                <ItemDescriptionType>08</ItemDescriptionType>\n" +
                "                <ProductDescription>VENDOR DESCRIPTION</ProductDescription>\n" +
   ...
   */
    ...
    void test2Scheels() {
        ...
        String poData = "<Order>\n" +
                ...
                "        <OrderHeader>\n" +
                "            <TradingPartnerId>CQKALLJUSTBRAND</TradingPartnerId>\n" +
                "            <PurchaseOrderNumber>40000041-1I1KDZ</PurchaseOrderNumber>\n" +
                "            <TsetPurposeCode>00</TsetPurposeCode>\n" +
                "            <PurchaseOrderTypeCode>DS</PurchaseOrderTypeCode>\n" +
                "            <PurchaseOrderDate>2019-05-09</PurchaseOrderDate>\n" +
                "            <Vendor>48952133</Vendor>\n" +
                ...
                "        <Address>\n" +
                "            <AddressTypeCode>ST</AddressTypeCode>\n" +
                "            <AddressName>TERRY WITRAK</AddressName>\n" +
                "            <Address1>272 LASALLE BLVD</Address1>\n" +
                "            <City>SUDBURY</City>\n" +
                "            <State>ON</State>\n" +
                "            <PostalCode>P3A 1W6</PostalCode>\n" +
                "            <Country>CA</Country>\n" +
                "            <Contact>\n" +
                "                <ContactTypeCode>OC</ContactTypeCode>\n" +
                "                <ContactName>TERRY WITRAK</ContactName>\n" +
                "                <PrimaryPhone>705-566-9870</PrimaryPhone>\n" +
                "            </Contact>\n" +
                "        </Address>\n" +
                "        <CarrierInformation>\n" +
                "            <CarrierAlphaCode>1449</CarrierAlphaCode>\n" +
                "            <CarrierRouting>UPS Standard</CarrierRouting>\n" +
                "        </CarrierInformation>\n" +
                "    </Header>\n" +
                "    <LineItems>\n" +
                "        <LineItem>\n" +
                "            <OrderLine>\n" +
                "                <LineSequenceNumber>1</LineSequenceNumber>\n" +
                "                <BuyerPartNumber>AH-BLP-5V-W-M</BuyerPartNumber>\n" +
                "                <VendorPartNumber>AH-BLP-5V-W-M</VendorPartNumber>\n" +
                "                <OrderQty>2</OrderQty>\n" +
                "                <OrderQtyUOM>EA</OrderQtyUOM>\n" +
                "                <PurchasePrice>80</PurchasePrice>\n" +
                "            </OrderLine>\n" +
                "            <ProductOrItemDescription>\n" +
                "                <ItemDescriptionType>08</ItemDescriptionType>\n" +
                "                <ProductDescription>VENDOR DESCRIPTION</ProductDescription>\n" +
                ...
                "            <OrderLine>\n" +
                "                <LineSequenceNumber>2</LineSequenceNumber>\n" +
                "                <BuyerPartNumber>AH-VST-5V-01-L</BuyerPartNumber>\n" +
                "                <VendorPartNumber>AH-VST-5V-01-L</VendorPartNumber>\n" +
                "                <OrderQty>1</OrderQty>\n" +
                "                <OrderQtyUOM>EA</OrderQtyUOM>\n" +
                "                <PurchasePrice>99</PurchasePrice>\n" +
                "            </OrderLine>\n" +
                "            <ProductOrItemDescription>\n" +
                "                <ItemDescriptionType>08</ItemDescriptionType>\n" +
                "                <ProductDescription>VENDOR DESCRIPTION</ProductDescription>\n" +
