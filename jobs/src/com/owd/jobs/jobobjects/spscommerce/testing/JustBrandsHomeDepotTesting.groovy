 ...
 */
class JustBrandsHomeDepotTesting extends GroovyTestCase{
        ...
        void test1shipOrderFromPoHomeDepot() {
                ...
                String poData = "<Order>\n" +
                        "    <Meta>\n" +
                        "        <InterchangeControlNumber>000000236</InterchangeControlNumber>\n" +
                        "        <GroupControlNumber>230</GroupControlNumber>\n" +
                        "        <DocumentControlNumber>0001</DocumentControlNumber>\n" +
                        "        <InterchangeSenderID>7703844115CH</InterchangeSenderID>\n" +
                        "        <InterchangeReceiverID>01694464YK</InterchangeReceiverID>\n" +
                        "        <GroupSenderID>7703844115CH</GroupSenderID>\n" +
                        "        <GroupReceiverID>01694464YK</GroupReceiverID>\n" +
                        "    </Meta>\n" +
                        "    <Header>\n" +
                        "        <OrderHeader>\n" +
                        "            <TradingPartnerId>9J6ALLJUSTBRAND</TradingPartnerId>\n" +
                        "            <PurchaseOrderNumber>98753185_TEST</PurchaseOrderNumber>\n" +
                        "            <TsetPurposeCode>00</TsetPurposeCode>\n" +
                        "            <PurchaseOrderTypeCode>SA</PurchaseOrderTypeCode>\n" +
                        "            <PurchaseOrderDate>2018-11-09</PurchaseOrderDate>\n" +
                        "            <ExchangeRate>100</ExchangeRate>\n" +
                        "            <Department>25</Department>\n" +
                        "            <Vendor>60006755</Vendor>\n" +
                        "            <CustomerOrderNumber>WD41940525</CustomerOrderNumber>\n" +
                        "        </OrderHeader>\n" +
                        "        <Date>\n" +
                        "            <DateTimeQualifier1>010</DateTimeQualifier1>\n" +
                        "            <Date1>2018-11-13</Date1>\n" +
                        "        </Date>\n" +
                        "        <Address>\n" +
                        "            <AddressTypeCode>BT</AddressTypeCode>\n" +
                        "            <AddressName>Debra Langeberg</AddressName>\n" +
                        "            <Address1>1360 Powell St N</Address1>\n" +
                        "            <City>BIG LAKE</City>\n" +
                        "            <State>MN</State>\n" +
                        "            <PostalCode>55309</PostalCode>\n" +
                        "            <Country>US</Country>\n" +
                        "            <Contact>\n" +
                        "                <PrimaryPhone>7632620792</PrimaryPhone>\n" +
                        "            </Contact>\n" +
                        "        </Address>\n" +
                        "        <Address>\n" +
                        ...
                        "            <AddressLocationNumber>8119</AddressLocationNumber>\n" +
                        "            <AddressName>Debra  Langeberg</AddressName>\n" +
                        "        </Address>\n" +
                        "        <Address>\n" +
                        "            <AddressTypeCode>PO</AddressTypeCode>\n" +
                        "            <LocationCodeQualifier>93</LocationCodeQualifier>\n" +
                        "            <AddressLocationNumber>8119</AddressLocationNumber>\n" +
                        "            <AddressName>Home Depot</AddressName>\n" +
                        "        </Address>\n" +
                        "        <CarrierInformation>\n" +
                        ...
                        "            <ReferenceID>675276954</ReferenceID>\n" +
                        "        </Reference>\n" +
                        "        <Reference>\n" +
                        "            <ReferenceQual>SD</ReferenceQual>\n" +
                        "            <ReferenceID>8119</ReferenceID>\n" +
                        "        </Reference>\n" +
                        "        <Reference>\n" +
                        "            <ReferenceQual>CT</ReferenceQual>\n" +
                        "            <ReferenceID>60006755</ReferenceID>\n" +
                        "        </Reference>\n" +
                        "    </Header>\n" +
                        "    <LineItems>\n" +
                        "        <LineItem>\n" +
                        ...
                        "                <BuyerPartNumber>303500084</BuyerPartNumber>\n" +
                        "                <VendorPartNumber>AH-JKT-5V-1-BW-XL</VendorPartNumber>\n" +
                        "                <ConsumerPackageCode>675595807862</ConsumerPackageCode>\n" +
                        "                <ProductID>\n" +
                        "                    <PartNumberQual>SK</PartNumberQual>\n" +
                        "                    <PartNumber>1002811964</PartNumber>\n" +
                        "                </ProductID>\n" +
                        "                <OrderQty>1</OrderQty>\n" +
                        "                <OrderQtyUOM>BG</OrderQtyUOM>\n" +
                        ...
                        "                <ProductDescription>Women's X-Large Black Softshell 5-Volt Heated Jacket</ProductDescription>\n" +
                        "            </ProductOrItemDescription>\n" +
                        "        </LineItem>\n" +
                        "    </LineItems>\n" +
                        "    <Summary>\n" +
                ...
                try {
                        ...
                        int docId = JustBrandsHomeDepotEDI.saveIncomingEdiDocForTesting(poData,"POtestfileamazon.xml",account)
                        JustBrandsHomeDepotEDI edi = new JustBrandsHomeDepotEDI();
                        EdiSpsConfigdata config = JustBrandsHomeDepotEDI.getEdiConfigData(po)
        ...
        @Test
        void testASNShipment(){
                SPSCommerceBaseClient.submitASN(16860612,626)
        }
        @Test
    ...
    void test3shipOrderCabelasWarehouse() {
        ...
        try {
            ...
            // checking the VendorPartNumber EDI element against a lookup in the edi_sps_configdata_skus table
            // for rows connected to the relevant edi_sps_configdata entry
            int docId = JustBrandsHomeDepotEDI.saveIncomingEdiDocForTesting(poData,"POtestfileamazon.xml")
            XmlParser parser = new XmlParser()
            parser.setTrimWhitespace(true)
            Node po =       parser.parseText(poData)
            EdiSpsConfigdata config = JustBrandsHomeDepotEDI.getEdiConfigData(po)
            Order order = JustBrandsHomeDepotEDI.importPo(po, config.clientFkey)
            println("Loaded the order xxxxxx");
   ...
   */
            ...
            String asnData = JustBrandsHomeDepotEDI.generateASN(Integer.parseInt(order.orderID),config.clientFkey)
