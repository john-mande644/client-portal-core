 ...
 */
class ROVRCampingWorldStockingTesting extends GroovyTestCase {
    ...
    void test1shipOrderFromPoCamping() {
        ...
        String poData = "<Order>\n" +
                ...
                "    <Header>\n" +
                "        <OrderHeader>\n" +
                "            <TradingPartnerId>089ALLROVRPRODU</TradingPartnerId>\n" +
                "            <PurchaseOrderNumber>3211036</PurchaseOrderNumber>\n" +
                "            <TsetPurposeCode>00</TsetPurposeCode>\n" +
                "            <PurchaseOrderTypeCode>DS</PurchaseOrderTypeCode>\n" +
                "            <PurchaseOrderDate>2020-10-26</PurchaseOrderDate>\n" +
                "            <SalesRequirementCode>BK</SalesRequirementCode>\n" +
                "            <BuyersCurrency>USD</BuyersCurrency>\n" +
                "            <Vendor>121313</Vendor>\n" +
                "        </OrderHeader>\n" +
                "        <PaymentTerms>\n" +
                ...
                "            <Date1>2020-07-20</Date1>\n" +
                "        </Date>\n" +
                "        <Contact>\n" +
                "            <PrimaryPhone>6506760719</PrimaryPhone>\n" +
                "        </Contact>\n" +
                "        <Contact>\n" +
                "            <ContactTypeCode>BD</ContactTypeCode>\n" +
                "            <ContactName>DALY</ContactName>\n" +
                "            <PrimaryEmail>LDALY@CAMPINGWORLD.COM</PrimaryEmail>\n" +
                "        </Contact>\n" +
                "        <Address>\n" +
                "            <AddressTypeCode>VN</AddressTypeCode>\n" +
                "            <AddressName>ICE ROVER INC dba ROVR PRODUCTS 121313</AddressName>\n" +
                "            <Address1>6333 Dry Creek Pkwy</Address1>\n" +
                "            <City>Niwot</City>\n" +
                "            <State>CO</State>\n" +
                "            <PostalCode>80503</PostalCode>\n" +
                "            <Country>US</Country>\n" +
                "        </Address>\n" +
                "        <Address>\n" +
                ...
                "            <AddressName>GEORGIALEEN PAGLINAWAN</AddressName>\n" +
                "            <Address1>17405 SW FOREST HOLLOW ST</Address1>\n" +
                "            <City>Beaverton</City>\n" +
                "            <State>OR</State>\n" +
                "            <PostalCode>97007-8749</PostalCode>\n" +
                "            <Country>US</Country>\n" +
                "            <Contact>\n" +
                ...
                "        </FOBRelatedInstruction>\n" +
                "        <CarrierInformation>\n" +
                "            <CarrierRouting>FEDEX HOME DELIVERY</CarrierRouting>\n" +
                "        </CarrierInformation>\n" +
                "    </Header>\n" +
                "    <LineItems>\n" +
                "        <LineItem>\n" +
                ...
                "                <BuyerPartNumber>118781</BuyerPartNumber>\n" +
                "                <VendorPartNumber>60MROLLRW</VendorPartNumber>\n" +
                "                <OrderQty>1</OrderQty>\n" +
                "                <OrderQtyUOM>EA</OrderQtyUOM>\n" +
                "                <PurchasePrice>247.5</PurchasePrice>\n" +
                "            </OrderLine>\n" +
                "            <ProductOrItemDescription>\n" +
                "                <ItemDescriptionType>08</ItemDescriptionType>\n" +
                "                <ProductDescription>60 QT Moss RollR</ProductDescription>\n" +
                "            </ProductOrItemDescription>\n" +
                "        </LineItem>\n" +
                "        <LineItem>\n" +
                "            <OrderLine>\n" +
                "                <LineSequenceNumber>2</LineSequenceNumber>\n" +
                "                <BuyerPartNumber>118785</BuyerPartNumber>\n" +
                "                <VendorPartNumber>APCKG</VendorPartNumber>\n" +
                "                <OrderQty>1</OrderQty>\n" +
                "                <OrderQtyUOM>EA</OrderQtyUOM>\n" +
                "                <PurchasePrice>40.5</PurchasePrice>\n" +
                "            </OrderLine>\n" +
                "            <ProductOrItemDescription>\n" +
                "                <ItemDescriptionType>08</ItemDescriptionType>\n" +
                "                <ProductDescription>Essentials Kit</ProductDescription>\n" +
                "            </ProductOrItemDescription>\n" +
                "        </LineItem>\n" +
                "    </LineItems>\n" +
                "    <Summary>\n" +
                "        <TotalAmount>288</TotalAmount>\n" +
