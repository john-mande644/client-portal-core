 ...
 */
public class EverythingDacorMagentoImportJob extends OWDStatefulJob {
private final static Logger log =  LogManager.getLogger();
    ...
    public void internalExecute() {
        ...
        try {
            ...
            MagentoRemoteService service = new MagentoRemoteService("http://everythingdacor.com/store/index.php/api/","OWD","one7172world",346);//438);
          ...
          //  service.setOrderCustomizer(getGildanImportOrderCustomizer());
            service.importMagentoOrders(100000005,-90);
       ...
       public void updateInventoryLevels(MagentoRemoteService service) throws Exception
    {
        ...
        HashMap<String,Integer> owdStockMap = new HashMap<String,Integer>();
         ...
         ResultSet rs = HibernateSession.getResultSet("select inventory_num,qty_on_hand,is_active from owd_inventory (NOLOCK) join owd_inventory_oh (NOLOCK) on inventory_id=inventory_fkey and client_fkey=346");
