...
public class VisionMediaShoutJob extends OWDStatefulJob implements OrderProcessingResultsHandler {
    private final static int kClientID = 716;
    ...
    private final static String kFileNamePrefix = "SHOUT";
