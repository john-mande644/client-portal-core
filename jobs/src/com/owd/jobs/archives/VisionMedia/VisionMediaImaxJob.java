...
public class VisionMediaImaxJob extends OWDStatefulJob implements OrderProcessingResultsHandler {
    private final static int kClientID = 714;
    ...
    private final static String kFileNamePrefix = "IMAX";
    private final static Logger log = LogManager.getLogger();
    private String status = "";
    SftpConnector ftp = new SftpConnector("ftp.owd.com", "visionmedia", "vsn2022$", "files", "aes128-ctr,aes128-cbc");
