 ...
 */
public class ModelBottleDogNoseItCart66ImportOrdersJob extends OWDStatefulJob {
private final static Logger log =  LogManager.getLogger();

    static String orderDownloadUrl = "https://mydognoseit.com/wp-content/plugins/cart66-owd-integration/cart66-owd-integration.php";
    ...
    public void internalExecute() {
        ...
        try {
            ...
            testConnection.setRequestProperty("Host", "mydognoseit.com");
           ...
           /* StringBuffer sb = new StringBuffer();
            ...
            ex.printStackTrace();
            Mailer.postMailMessage("ModelInABottle DogNoseIt Cart66 import error", sb.toString(), "owditadmin@owd.com", "donotreply@owd.com");
        }
